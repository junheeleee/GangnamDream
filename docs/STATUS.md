...
>
> 생성 시각 · 커밋: `2026-08-18 12:49 UTC · a2128825`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-113` | 창업 | 진행 | 16/43 L1·독립 L2 GO — L3 보류 |
| `ORDER-112` | 마지막 해 career 실제 세로줄 | 진행 | 16/43 L1·독립 L2 GO — L3 보류 |
| `ORDER-111` | 지연·생존 / 무연애·미실행 두 세로줄 | 진행 | 24/58 L1·L2 GO — L3 보류 |
| `ORDER-110` | M49~M60 기준 세로줄 | 진행 | 20/51 L1·L2 GO — L3 보류 |
