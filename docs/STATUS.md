...
>
> 생성 시각 · 커밋: `2026-09-09 07:51 UTC · 6c8cc6ce`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-215` | CI 자각 모달 입력 | 진행 | W17→W18 표적 재현·수리 |
| `ORDER-216` | 위임 최종 검수 운영 | 진행 | 판정·인간 증거 분리 구현 중 |
| `ORDER-214` | 생활 선택·부채·직장 번역 | 진행 | 24종507문구 저작·독립 검수 |
