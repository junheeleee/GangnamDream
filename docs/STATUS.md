...
>
> 생성 시각 · 커밋: `2026-08-10 23:34 UTC · e4239d3f`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-88` | 독자 없는 아버지 기억과 24주 중복 영수증 정리 | 진행 | 착수 — 기존 21주 건강 신호·24주 첫 청구서가 여섯 기억을 읽고, 정확 추적 영수증을 남긴 채 네 중복 기록만 퇴역 |
| `ORDER-96` | LOC-0 다의 한국어 UI 키를 안정 문맥 ID로 분리 | 미착수 | ORDER-88 종료 대기 — 2,730 legacy 키를 보존하며 28키를 30 ID·37호출로 분리 |
