...
>
> 생성 시각 · 커밋: `2026-09-08 12:04 UTC · 5266d9d0`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-202` | 현수·가족·건강·목표 후속 번역 | 진행 | 41장면·두 배치·세 언어 저작 |
...
| `ORDER-203` | 원어민 게이트를 미검수 표시로 내린다 | 미착수 | 원장 7건·유저 표면 고지 · 선행 없음·미착수 |
| `ORDER-204` | 도달 불가 L3에 묶인 번역 오더 44건 종결 | 미착수 | 종결 규칙·44건 아카이브 · 선행 203 · 미착수 |
