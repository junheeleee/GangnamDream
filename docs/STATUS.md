...
>
> 생성 시각 · 커밋: `2026-09-02 06:53 UTC · 236d8eb2`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-150` | Ch5 human REJECT 수리 | 진행 | exact 236d8eb active · 두 replay OPEN · HOLD |
...
| `ORDER-146` | ledger | 진행 | exact 236d8eb active · 두 replay OPEN |
