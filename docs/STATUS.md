...
>
> 생성 시각 · 커밋: `2026-08-05 04:51 UTC · b344d641`
...
| `ORDER-89` | 계획판 진행 표시를 확정 조건에 맞춘다 | 미착수 | 레일이 남은 수량을 세고 내비게이션을 한 겹으로 |
| `ORDER-90` | 판정을 주는 `유혹` 라벨을 표면에서 제거 | 미착수 | 착수 전 표면 라벨 사용자 결정 필요 |
