...
>
> 생성 시각 · 커밋: `2026-08-28 07:39 UTC · 9909437d`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-137` | 5장 실플레이 반려 4건을 표적 수리한다 | 진행 | 9909437/b375af2 실제 플레이 property CONDITIONAL·general REJECT · chapter5_finale_rc waiting_rebuild · M55 통과/사실 안전선 보존 · 새 exact 후보에서 두 full L3 필수 · main HOLD |
| `ORDER-135` | 25억 문턱·아버지 별세 일반 런의 선택을 W240에 잇는다 | 진행 | 역사 후보 b375af2 자동·화면 GREEN · 인간 L3 REJECT · ORDER-137 재작업 중 · 사용자 최종 GO/main HOLD |
