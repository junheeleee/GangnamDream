...
>
> 생성 시각 · 커밋: `2026-08-18 09:02 UTC · dcb7c275`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-110` | M49~M60 기준 경로를 계약 도착부터 마지막 주까지 실제 사건 20개로 완주한다 | 진행 | 20 roots·51 choices L1/L2·독립 GO — 사용자 3개 L3 보류 |
...
| `ORDER-108` | M39~M48의 세 약속·몸·빌린 이름·마지막 연락을 실제 원고 25개로 푼다 | 진행 | 25 roots·75 choices L1/L2·독립 GO — 복합 원고 reference-only, L3 보류 |
...
| `ORDER-97` | LOC-0.5 전에 UI 템플릿을 번역 | 진행 | L1/L2 완료 — 최신 후보와 Batch A/B 각 3표면 L3 대기 |
