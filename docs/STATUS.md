...
>
> 생성 시각 · 커밋: `2026-08-22 10:10 UTC · 63090db5`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-119` | 게임 전체 플레이어 표면에서 스탯·시스템 언어 제거 | 진행 | 36파일 범위 확정 · 첫 full audit EN_HANGUL_EXIT·IMMERSION_EXIT exact 수리/targeted green · STATUS_DOC_EXIT는 최종 생성 대기 · 최종 full audit·직렬 KO/EN 24주·KO 240주·package 대기 · 사용자 최종 GO OPEN |
