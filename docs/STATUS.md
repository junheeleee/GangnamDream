...
>
> 생성 시각 · 커밋: `2026-09-03 04:16 UTC · af511eea`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-151` | Ch5 장소·기간·카지노 맥락 | 진행 | af511ee Codex 화면 관찰 두 경로 REJECT · 재빌드 · HOLD |
