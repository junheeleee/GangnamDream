...
>
> 생성 시각 · 커밋: `2026-08-04 09:22 UTC · edab25fc`
...
|---|---|---|---|---|
| `P-11` | 큐 문서의 85%가 프로토콜과 완료 이력이라 오더 제목이 두 글자로 깎였다 | 하면: 완료 이력을 볼 때 한 번 더 클릭한다. `queue_consistency_check` | ****1번만 한다.** 이미 정해 둔 처방이고, 되돌리기 쉽고, 새 규칙을** | 2026-08-04 |
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-85` | 문체 | 진행 | 72·447 전수 |
| `ORDER-84` | 1원 | 미착수 | P-10 뒤 |
