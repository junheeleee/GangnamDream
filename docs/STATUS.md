...
>
> 생성 시각 · 커밋: `2026-08-22 00:40 UTC · 814f84b6`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-123` | W9 다중 약속 선택판의 3~4개 후보를 보존해 24주 입력 정지를 복구한다 | 진행 | 제품·로컬 full audit GO · 원격 KO가 W9 경로 통과 뒤 W15에서 420초 timeout(exit 124) · KO/EN 1200초 상한·원격 CI green 대기 |
| `ORDER-119` | 게임 전체 플레이어 표면에서 스탯·시스템 언어 제거 | 진행 | 구현·KO/EN 24주·KO 240주·정적 CI·ORDER-123 KO/EN 24주·최종 full audit 완료 · ORDER-123 원격 CI green 뒤 마감 재개 · 사용자 최종 GO OPEN |
