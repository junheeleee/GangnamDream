...
>
> 생성 시각 · 커밋: `2026-08-29 06:20 UTC · 02bb0e8a`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-138` | 5장 일반 종막의 9주 공백과 아버지 기일 회수를 고친다 | 진행 | 선언 02bb0e8 · W224/W229/W234 exact 흐름과 property inline read로 범위 확정 · general 최장 공백 목표 4주, 산술 정정 기준 29/48주 · main HOLD |
