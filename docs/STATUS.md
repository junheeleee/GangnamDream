...
>
> 생성 시각 · 커밋: `2026-09-07 12:57 UTC · a7fc011a`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-172` | 가족·직장·친구 번역 | 진행 | A25/B25 · 380문구/언어 · L3 OPEN |
| `ORDER-171` | 데이트·계절 장면 번역 | 진행 | 627번역 L1/L2 · L3 OPEN |
| `ORDER-170` | 결혼·가족 장면 번역 | 진행 | 618번역 L1/L2 · L3 OPEN |
| `ORDER-169` | 일본어 원화 단위 정밀화 | 진행 | 기존2문구 L1/L2 · L3 OPEN |
| `ORDER-168` | 다은 관계·통화 번역 | 진행 | 492번역 L1/L2 · L3 OPEN |
| `ORDER-167` | 종막 서명·선발신 번역 | 진행 | 591번역 L1/L2 · L3 OPEN |
| `ORDER-166` | 마지막 해 번역 | 진행 | 1,074번역 L1/L2 · reader78/언어 · L3 OPEN |
| `ORDER-165` | 데모 간체 수량 정밀화 | 진행 | 한 문장 수리 L1/L2 · L3 OPEN |
| `ORDER-164` | 4년차와 아버지 경과 번역 | 진행 | 1,380번역 L1/L2 · 조건128/언어 · L3 OPEN |
| `ORDER-163` | 3년차와 장기 후속 번역 | 진행 | 1,089번역 L1/L2 · foreshadow4/언어 · L3 OPEN |
| `ORDER-162` | M07~M24 연결 사건 번역 | 진행 | 837번역 L1/L2 · 조건변형28 보존 · L3 OPEN |
| `ORDER-161` | catalog 전체 번역 | 진행 | 2,502문구 L1/L2 · 신규2,485·기존수리1 · L3 OPEN |
| `ORDER-160` | 남은 결말18종 번역 | 진행 | 387번역 L1/L2 · 엔딩35종 본문 채움 · L3 OPEN |
| `ORDER-159` | 일상·회복 결말 14종 번역 | 진행 | 249번역 L1/L2 · 비표시 메타 제외 · L3 OPEN |
| `ORDER-158` | 본편 8장면 번역 | 진행 | KO 직접 20단위 · 세 언어 독립 · 원어민 OPEN |
| `ORDER-157` | 본편 일본어·중국어 전체 번역 | 진행 | 전체 분모·증분 배치 · 엔딩 75문구 검사 · 원어민 OPEN |
| `ORDER-156` | Ch5 생활 routine 실제 배경 | 진행 | 제품 53493fe · 입력 QA 잔여 · 사람 OPEN·HOLD |
| `ORDER-151` | Ch5 장소·기간·카지노 맥락 | 진행 | 두 경로 Codex 6/6 · 배경 수리 후속 156 · 사람 OPEN·HOLD |
