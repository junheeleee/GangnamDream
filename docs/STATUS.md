...
>
> 생성 시각 · 커밋: `2026-09-03 05:54 UTC · 7a83ce9f`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-151` | Ch5 장소·기간·카지노 맥락 | 진행 | L1/L2·전체 재감사 GREEN · exact RC 봉인 · 두 사람 gate OPEN·HOLD |
| `ORDER-150` | Ch5 human REJECT 수리 | 진행 | 후속 151 수리 중 · 두 사람 gate OPEN · HOLD |
...
| `ORDER-146` | ledger | 진행 | 후속 151 재빌드 · 두 replay OPEN |
