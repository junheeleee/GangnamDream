...
>
> 생성 시각 · 커밋: `2026-08-18 05:24 UTC · 28cfaa75`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-107` | M25~M36의 아버지 기록·재혁 피치·관계 이탈·상철 진실 후속 20개를 실제 원고로 푼다 | 진행 | 신규 20 roots·60 choices/locale L1/L2, 독립 P0/P1 0 완료 — 사용자 무작위 3개 L3 보류 |
| `ORDER-106` | M13~M24의 압축 연쇄와 빈 경로 24개를 실제 원고로 푼다 | 진행 | 24 roots·70 choices/locale L1/L2, 독립 P0/P1 0 완료 — 사용자 무작위 3개 L3 보류 |
