...
>
> 생성 시각 · 커밋: `2026-08-11 02:13 UTC · a741a328`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-97` | LOC-0.5 값을 끼우기 전에 UI 템플릿을 번역 | 진행 | 착수 — preformat 후보 54개를 전수 분류하고 정확 46호출만 lookup→format 순서로 바꿔 JA/ZH의 영구 EN fallback을 제거 |
