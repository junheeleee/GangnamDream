...
>
> 생성 시각 · 커밋: `2026-08-10 21:03 UTC · a7893e0c`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-95` | 참조작 전수 분석 판정표 | 미착수 | ORDER-94 완료 뒤. 구현 없이 가져올 것·버릴 것만 판정 |
