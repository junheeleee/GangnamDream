...
>
> 생성 시각 · 커밋: `2026-08-03 12:07 UTC · 0f867a8d`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-76` | 넓은 월간 계획판과 세로 연락폰 분리 | 진행 | 기종 구매 종료, 일정·금융 본화면 복원, 문자·통화 세로폰 분리 |
| `ORDER-74` | 신규 데모 지식·화자 계약 | 대기 | 사용자 실플레이 UI 수리를 먼저 끝낸 뒤 27개 대화 계약으로 복귀 |
