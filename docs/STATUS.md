...
>
> 생성 시각 · 커밋: `2026-08-18 08:07 UTC · 9a376aee`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-109` | M34 여섯 결말을 여섯 사건으로 다시 쓰고 계약 보고체·시계형 도입을 산문으로 되돌린다 | 진행 | exact 16 roots L1/L2·독립 P0/P1 0 완료 — 정점 8편 불변, 사용자 무작위 3개 L3 보류 |
| `ORDER-108` | M39~M48의 세 약속·몸의 목격자·빌린 이름·마지막 연락을 세 사람 경로의 실제 원고 25개로 푼다 | 진행 | 25 roots·75 choices/locale L1/L2, 독립 P0/P1 0 완료 — 복합 selector 원고 reference-only, 사용자 무작위 3개 L3 보류 |
| `ORDER-107` | M25~M36의 아버지 기록·재혁 피치·관계 이탈·상철 진실 후속 20개를 실제 원고로 푼다 | 진행 | 신규 20 roots·48 choices/locale L1/L2, 독립 P0/P1 0 완료 — 사용자 무작위 3개 L3 보류 |
...
| `ORDER-97` | LOC-0.5 값을 끼우기 전에 UI 템플릿을 번역 | 진행 | 구현·L1/L2 완료, 현재 원장 56후보·48이동·43템플릿·50 ui_format 정합 — 최신 후보 재발급과 Batch A 23/B 25 임의 3표면 L3 대기 |
