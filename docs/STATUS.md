...
>
> 생성 시각 · 커밋: `2026-08-24 05:26 UTC · 1561bac7`
...
| `ORDER-124` | 월간 행동판 없이 스토리 선택만으로 M01~M06을 잇는다 | 진행 | ORDER-103 사용자 NO-GO 반영 · 실제 StoryMode·자동 시간/경제 독립 후보 구현 중 |
