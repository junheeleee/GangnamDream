...
>
> 생성 시각 · 커밋: `2026-08-24 00:59 UTC · 20ec3fb0`
...
> **활성 demo_rc 주의:** 데모 제품 경계는 W1~24 CTA다. BUILD 2026.08.22.1은 숫자 여력 네 장을 쓰는 `서울의 네 주` 기준선이며 ORDER-103 M01~M06 선택판이 아니다. clean revision ebc58a839d64d8810b9da5548c20e58bc43c9e30 / tree f978a22525b678ef83619dc50094a6dada75f190의 Windows·macOS·Linux V2 playtest 후보고, 같은 후보의 full audit·KO/EN 24주·KO 240주와 package identity/manifest 검증, macOS native no-arg smoke가 PASS했다. 자동 증거는 사용자 최종 GO를 대신하지 않는다. demo_rc의 사람·실기기·연속 A/V·원어민 게이트와 고정 order99_build_3_rc의 사용자 게이트는 OPEN이다. 독립 active order103_rc와 그 사용자 게이트도 별도 OPEN이며 서로 대신하지 않는다. W25~48 Chapter 1은 데모 RC나 사람 판정 조건이 아니다.
...
| `ORDER-103` | M01~M06 월간 약속을 직접 고르는 독립 체험판을 만든다 | 진행 | BUILD 2026.08.24.1 전용 macOS order103_rc active · 무인자 진입·KO/EN·저장 재개·격리 L2 GO · 지금 사용자 L3 |
