...
>
> 생성 시각 · 커밋: `2026-09-26 15:07 UTC · ab376c57`
...
|---|---|---|---|---|
| `P-19` | 해시 고정 역사 self-test 3개를 CI 필수 게이트에서 내리고 기록으로 보관한다 | 과거 오더의 바이트 단위 재현 보증을 잃는다. 과거 판정 기록 자체는 | **한다. 대안인 successor 등록은 이번 3건을 닫지만 다음 수정에서 같은** | 2026-09-24 |
