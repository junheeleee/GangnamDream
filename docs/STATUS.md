...
>
> 생성 시각 · 커밋: `2026-09-02 06:15 UTC · 23f77d00`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-150` | Ch5 human REJECT 수리 | 진행 | exact 236b233 active · 두 replay OPEN · HOLD |
...
| `ORDER-146` | ledger | 진행 | exact 236b233 active · 두 replay OPEN |
