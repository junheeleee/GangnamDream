...
>
> 생성 시각 · 커밋: `2026-08-18 09:19 UTC · 0a082893`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-111` | 마지막 해의 지연·생존 경로와 무연애·미실행 경로를 실제 사건으로 완주한다 | 진행 | 24 신규 원고 착수 — 엔딩 35개 불변 |
| `ORDER-110` | M49~M60 기준 경로를 계약 도착부터 마지막 주까지 실제 사건 20개로 완주한다 | 진행 | 20/51 L1/L2 GO — 사용자 3개 L3 보류 |
| `ORDER-109` | M34 여섯 결말을 여섯 사건으로 다시 쓰고 계약 보고체·시계형 도입을 산문으로 되돌린다 | 진행 | 16 roots L1/L2 GO — 사용자 3개 L3 보류 |
| `ORDER-108` | M39~M48의 세 약속·몸·빌린 이름·마지막 연락을 실제 원고 25개로 푼다 | 진행 | 25/75 L1/L2 GO — L3 보류 |
| `ORDER-107` | M25~M36의 아버지 기록·재혁 피치·관계 이탈·상철 진실 후속 20개를 실제 원고로 푼다 | 진행 | 20/48 L1/L2 GO — L3 보류 |
| `ORDER-106` | M13~M24의 압축 연쇄와 빈 경로 24개를 실제 원고로 푼다 | 진행 | 24/70 L1/L2 GO — L3 보류 |
| `ORDER-105` | M02~M12의 빈 장면과 중복 장면 20개를 실제 원고로 고친다 | 진행 | 20 roots L1/L2 GO — L3 보류 |
| `ORDER-104` | 처음부터 완결까지 22개 핵심 장면의 실제 원고를 쓴다 | 진행 | 23 roots L1/L2 — L3 보류 |
