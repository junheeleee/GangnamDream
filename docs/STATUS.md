...
>
> 생성 시각 · 커밋: `2026-08-26 22:49 UTC · bc1006f4`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-135` | 25억 문턱·아버지 별세 일반 런의 선택을 W240에 잇는다 | 진행 | 선언 기준 bc1006f · 신규 4 roots/10 choices·general finale 3/8 · L1/L2 구현 중 · L3 후보 빌드 전 OPEN |
