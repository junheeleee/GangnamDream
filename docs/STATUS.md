...
>
> 생성 시각 · 커밋: `2026-08-22 11:23 UTC · ebc58a83`
...
> **활성 demo_rc 주의:** 데모 제품 경계는 W1~24 CTA다. BUILD 2026.08.22.1은 clean revision ebc58a839d64d8810b9da5548c20e58bc43c9e30 / tree f978a22525b678ef83619dc50094a6dada75f190의 Windows·macOS·Linux V2 playtest 후보다. 같은 후보의 full audit·KO/EN 24주·KO 240주와 package identity/manifest 검증, macOS native no-arg smoke가 PASS했다. 자동 증거는 사용자 최종 GO를 대신하지 않는다. demo_rc의 사람·실기기·연속 A/V·원어민 게이트는 OPEN이고, 고정 order99_build_3_rc와 waiting_rebuild order103_rc 및 두 사용자 게이트도 그대로 OPEN이다. W25~48 Chapter 1은 데모 RC나 사람 판정 조건이 아니다.
...
| order103-close, demo · 최신 정본 StoryMapM1M6Playtest의 고시원 배경·약속 장면 카드·주력/함께 역할 선택으로 M01~M06을 완주하는 독립 체험판 | **ORDER-103 M01~M06 약속 선택판 사용자 재판정**<br><sub>자동 검사는 여섯 달의 주력·함께·여유·미룸·저장과 입력을 증명한다. 장면 카드가 업무 대시보드가 아니라 실제로 무엇을 지키고 버릴지 고민하는 게임으로 읽히는지는 사용자가 직접 판정해야 한다.</sub> | `order103_rc · REBUILD 대기` | order103_m1_m6_reworked_choice_surface<br>현재 order103_rc는 재빌드 대기다. source floor 5729b14af5f36af15a57cb21b8332e871224061f 이후의 최신 정본 독립 장면을 포함한 전용 후보가 발급된 뒤에만 KO 또는 EN, 960×600 또는 1280×800로 새 시작<br>마우스·키보드·실제 패드 중 하나로 M01~M06의 주력과 가능한 함께를 직접 배정하고 결과·회고까지 정상 독해<br>가장 고민한 달, 버린 약속, 닫힌 문, 항상 둘째가 정답처럼 느껴졌는지를 유도 문구 없이 말함 | 주력과 함께의 역할을 이해하고 첫 확인이 자동 배정이 아니라 역할 자리 이동으로 읽힘<br>한 번 이상 실제로 무엇을 버릴지 고민하며 함께가 항상 정답처럼 느껴지지 않음<br>닫힌 문이 숨은 벌점이 아니라 자기 경로의 결과로 읽히고 선택 전 미래 결과 스포일러가 없음<br>장면 카드가 업무 대시보드가 아니라 게임으로 읽히며 사용자가 ORDER-103에 최종 GO한 뒤에만 기존 24주 판 이관을 시작함 | `ORDER-103` |
