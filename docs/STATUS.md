...
>
> 생성 시각 · 커밋: `2026-09-04 16:09 UTC · 4f4689e0`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-153` | W237 익명 보증·M53 재혁 보증 충돌 | 진행 | W192 조회 보존·W193+ 재진입 차단 · 새 정확 후보 전 두 사람 gate OPEN·HOLD |
| `ORDER-151` | Ch5 장소·기간·카지노 맥락 | 진행 | 042f5ea 두 경로 6/6 Codex 관찰 · W237 보증 중복·배경·이름표 결함 · 두 사람 gate OPEN·HOLD |
