...
>
> 생성 시각 · 커밋: `2026-08-18 07:44 UTC · 026180be`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-109` | M34 여섯 결말을 여섯 사건으로 다시 쓰고 계약 보고체·시계형 도입을 산문으로 되돌린다 | 진행 | 착수 선언 — exact 16 roots·KO/EN 10파일, 정점 8편·story map·런타임 불변 |
