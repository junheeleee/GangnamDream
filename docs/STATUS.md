...
>
> 생성 시각 · 커밋: `2026-09-12 09:33 UTC · d7733c4a`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-241` | 중국어 단수 생략 검사 오탐 | 진행 | 고정30·오탐2 수리 · 최종 검수 진행 · 본편 HOLD |
| `ORDER-240` | 관계 패널 현지화·표시 수리 | 진행 | 90수용·actual80/회귀65 · 최종 검수 진행 · 본편 HOLD |
