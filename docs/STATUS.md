...
>
> 생성 시각 · 커밋: `2026-08-10 23:43 UTC · e4239d3f`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-96` | LOC-0 다의 한국어 UI 키를 안정 문맥 ID로 분리 | 진행 | 착수 — 2,730 legacy 키를 보존하며 28키를 30 ID·37호출로 분리해 JA/ZH 본문 번역의 의미 충돌을 먼저 제거 |
