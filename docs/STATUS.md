...
>
> 생성 시각 · 커밋: `2026-08-12 03:58 UTC · 1693ed6a`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-100` | CH1-LEDGER-0 48주 인과 원장과 현재 부채를 먼저 고정한다 | 진행 | L1/L2 완료 — 48행 전수 원장·debt 60·완성 게이트를 봉인했고 사용자 L3 범위·공백·수리 순서 판정 대기 |
