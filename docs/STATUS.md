...
>
> 생성 시각 · 커밋: `2026-09-12 14:35 UTC · 0cff6d5c`
...
판정 근거: 현재 후보 신원 미확정 또는 작업 트리 변경 중
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-247` | CI 감사 실행 지문 | 진행 | 지문1원인 · 고정25 · 본편 HOLD |
| `ORDER-248` | 투자·자산·인생 칭호 번역 | 진행 | 기존11칭호22표면 · 세 언어66 준비 · 본편 HOLD |
| `ORDER-249` | 인생 회차 수량 검사 정합 | 진행 | JA4 오탐 · 고정대조 준비 · 본편 HOLD |
