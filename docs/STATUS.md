...
>
> 생성 시각 · 커밋: `2026-08-20 13:36 UTC · 911e5a7e`
...
| ID | 제목 | 상태 | 현재 게이트 |
|---|---|---|---|
| `ORDER-116` | career 결말 구조 재설계 | 진행 | 17단위 L2 GO — 사람 L3 대기, 원고·R1b 동결 |
| `ORDER-113` | 창업 | 진행 | 16/43 L3 구조 반려 — career 재설계 뒤 별도 topology 필요 |
| `ORDER-112` | career 세로줄 | 진행 | 16/43 L3 구조 반려 — ORDER-116으로 재설계 |
| `ORDER-111` | 마지막 해 대체 세로줄 | 진행 | 24/58 L1·L2 GO — 선택층·코드 표면 후속 보정 대기 |
