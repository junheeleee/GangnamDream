...
| Display / console readiness | Developing | 1280x800, 1080p, QHD, 4K, and 3440x1440 real renders preserve TV-safe settings/AP/story surfaces and 21:9 expands the scene without moving decisions offstage. 720p hardware, sofa-distance readability, suspend/resume, raster-master review, and platform certification remain |
