...
| Core weekly loop | Scene-first weekly commitment passes, fun unproven | The base calendar exposes 52 scheduled Decision/Boss weeks distributed 12/10/10/10/10, 20 Echoes, 20 blocking summaries, and a final week-240 ledger absorbed into the ending. AP remains an internal economy budget, but a direct week now hides the AP chip, portrait rail, calculation board, Seoul Trace, and separate Next Week command. The random director now permits only 61 standalone foreground scenes and 18 state-causal single-choice bridges from seven material producer roots. Korean PlayStation and English Xbox runs reach the same `with_daeun` ending after 240 weeks, 226 events, two causal bridges, and 3,120/3,148 inputs with zero keyboard/mouse input. This is reachability and consequence-legibility evidence rather than a fun pass |
