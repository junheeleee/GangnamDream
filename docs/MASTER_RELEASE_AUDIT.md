...
| Core weekly loop | Contextual runtime cadence passes, fun unproven | Two real controller routes cross the title, opening, all 240 weeks, five chapters, every AP grant, and an actual ending. The base calendar exposes 52 scheduled Decision/Boss weeks distributed 12/10/10/10/10, 20 Echoes, 20 blocking summaries, and a final week-240 ledger absorbed into the ending. Direct weeks now derive one of seven pressure families from the live job, home, person, portfolio, body, recent time split, and remaining calendar, then expose exactly three existing actions. Quarterly capital pressure prevents calendar aliasing; the latest EN route shows at least four families in every chapter and no family streak beyond three. The user still judged the demo's short-event experience NO-GO, so this remains reachability and menu-variety evidence rather than a fun pass |
...
| Chapter pacing | Causal distribution implemented, late path still lean | Representative roots now distribute `26/25/26/16/13` and `28/24/32/23/15`, with zero isolated micro-scenes in all five chapters. Chapter 1 holds eight chains, Chapter 2 four, Chapter 3 four temporal spines, and the late chapters preserve week-spanning body, family, relationship, and money consequences. Path A and Chapter 5 remain numerically lean; add no filler until recall and emotional carry are tested |
...
| Image quality / continuity | Developing, resolution debt measured | Background/portrait separation, romance outfit pairs, spatial bibles, 59 active CG and 235 locked event visual contracts gate high-risk scenes. The active 195-raster ledger now measures every 1080p/4K cover scale and blocks path or dimension regressions: 57 portraits are native at the authored 1080p portrait target, no active raster is native at 4K, and 138 full-screen CG/background files enlarge 3x. Fifty-two demo/store/A-or-higher-ending assets are P0 for final masters. Dimensions do not certify faces, hands, continuity, or TV viewing quality; those remain production and human gates |
