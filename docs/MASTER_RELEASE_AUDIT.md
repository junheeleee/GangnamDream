...
| Chapter pacing | Front load reduced, late paths still lean | Representative stops now distribute `30/24/26/16/12` and `32/24/31/23/14`. Chapter 2 holds 4 chains, 2 peaks, and only 2 isolated micros on both paths. Chapter 3 holds four temporal spines, 2-4 peaks, and zero isolated scenes while preserving delayed consequences across the weekly hub. Both late chapters pass phase/chain/peak ratchets, but Path A and Chapter 5 remain numerically lean. Add no filler until recall and emotional carry are tested |
...
| Image quality / continuity | Developing | Background/portrait separation, romance outfit pairs, spatial bibles, 59 active CG and 203 locked event visual contracts now gate high-risk scenes. Chapters 2-3 additionally lock current housing, office/message, convenience, restaurant, street, cafe, hospital-result, remote-call, and delayed-mirror ownership. Explicit winter/night/private-room/transit/cast/cultural art debts remain, so recurring-cast seasons and climax coverage are still incomplete |
