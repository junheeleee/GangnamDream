...
|---|---:|---|
| KO events | 1,525 | Consistent prose, reachability, pacing, or relevance |
| EN event overlays | 1,525 | Native English voice or cultural clarity |
| Choices per language | 3,393 | Meaningful tradeoffs or delayed consequence |
...
| Screenshot QA scopes | 59 | Full-playthrough correctness or subjective fun |
...
| Image quality / continuity | Developing | Background/portrait separation, romance outfit pairs, spatial bibles, 57 active CG and 125 locked event visual contracts now gate high-risk scenes. Explicit winter/night/private-room/transit/cast/cultural art debts remain, so recurring-cast seasons and climax coverage are still incomplete |
...
|---|---:|---|
| Events / authored / random pool | 1,525 / 348 / 1,177 | Stop adding volume; curate priority and causality |
