...
|---|---:|---|
| KO events | 1,537 | Consistent prose, reachability, pacing, or relevance |
| EN event overlays | 1,537 | Native English voice or cultural clarity |
| Choices per language | 3,409 | Meaningful tradeoffs or delayed consequence |
...
| Screenshot QA scopes | 60 | Full-playthrough correctness or subjective fun |
...
| Image quality / continuity | Developing | Background/portrait separation, romance outfit pairs, spatial bibles, 57 active CG and 139 locked event visual contracts now gate high-risk scenes. Explicit winter/night/private-room/transit/cast/cultural art debts remain, so recurring-cast seasons and climax coverage are still incomplete |
...
|---|---:|---|
| Events / authored / random pool | 1,537 / 360 / 1,177 | Stop adding volume; curate priority and causality |
