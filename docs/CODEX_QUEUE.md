...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-90 · 판정을 주는 `유혹` 라벨을 표면에서 제거 | [90](queue_active/ORDER-90.md) | 착수 — 중립 표면 분류·첫 설명·Month 2 한영 실제 화면, 내부 kind·효과·저장 불변 |
| 2 | [ ] | ORDER-91 · 계획판 카드를 출처가 있는 물건으로 | [91](queue_active/ORDER-91.md) | ORDER-90 뒤 착수. 첫 달 4개 출처·물성 |
| 3 | [ ] | ORDER-88 · 독자 없는 아버지 기억과 24주 중복 영수증 정리 | [88](queue_active/ORDER-88.md) | 새 카드를 늘리지 않고 기존 장면 안에서 여섯 기억과 네 중복 기록을 닫기 |
