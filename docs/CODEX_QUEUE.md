...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-119 · 게임 전체 플레이어 표면에서 스탯·시스템 언어 제거 | [119](queue_active/ORDER-119.md) | 36파일 범위 확정 · 첫 full audit `EN_HANGUL_EXIT`·`IMMERSION_EXIT` exact 수리/targeted green · `STATUS_DOC_EXIT`는 최종 생성 대기 · 최종 full audit·직렬 KO/EN 24주·KO 240주·package 대기 · 사용자 최종 GO OPEN |
