...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-151 · Ch5 장소·기간·카지노 맥락 | [151](queue_active/ORDER-151.md) | 042f5ea 두 경로 6/6 Codex 관찰 · 보증·이름표·저작 배경 완료 · routine settled-frame 묶음 남음 · 두 사람 gate OPEN·HOLD |
...
| 6 | [~] | ORDER-146 · ledger | [146](queue_active/ORDER-146.md) | 후속 151 새 exact 후보 · 두 replay OPEN |
