...
| 4 | [~] | ORDER-103 · M01~M06 월간 약속을 직접 고르는 독립 체험판을 만든다 | [103](queue_active/ORDER-103.md) | 이미지 장면 카드·호버/포커스 L1/L2 GO · 기존 24주 `demo_rc`와 분리한 전용 macOS `order103_rc` 발급 → 사용자 L3 |
