...
- `[x] ORDER-82` (2026-08-04): 간·번체의 한국어 직번역·실패·전용 글꼴·
  원어민 판정선을 분리했다. 246회귀 통과, strict는 미번역·영어 직행
  13·AUTO·글꼴을 20개 사유로 막는다. 번역·폰트·출시 노출은 만들지 않았다.
  [사양](queue_archive/ORDER-82.md)
- `[x] ORDER-81` (2026-08-04): 실제 24주를 70사건·431본문 문구·486개 동적
  한영 쌍(479고유)·시장 자산 4개·엔딩 0개로 잠갔다. 편의점·배달·자소서·
  모의면접의 모든 합법 무작위 표면을 포함하고 비도달 레거시 풀은 제외했다.
  준비 언어의 직접 영어 우회는 0이며 일본어 본문·출시 노출은 보류했다.
