...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-131 · M39~M48 오프스크린 선택을 StoryMode 행동으로 바꾸고 아버지 시간선을 잇는다 | [131](queue_active/ORDER-131.md) | 선언 · ORDER-130 exact full audit GREEN 기준선 · 23 기능 단위 KO/EN 행동·영수증·보호주·생사 단조 회귀 대기 |
