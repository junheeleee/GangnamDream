...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-57 · Core Loop V2 데모 재구축 | [ORDER-57](queue_active/ORDER-57.md) | A1 자동 PASS: 1~8주 루틴 16단위·포기 소비자·기한·선택 관계·합법 경제·월말 회수 완료. B 9~12주 첫 만남 인과 착수 전, 기본 전환·사람 GO는 OPEN |
