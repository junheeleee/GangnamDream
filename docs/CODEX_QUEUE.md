...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-119 · 게임 전체 플레이어 표면에서 스탯·시스템 언어 제거 | [119](queue_active/ORDER-119.md) | 착수 선언 · 16주 정지는 제품 버그 아님 · 동적 조립·기존 검사 정렬 포함 20파일 범위 확정 · A1~A4/9토스트/C1~C4/전역 lint 구현 중 |
