...
**진행 상태 (2026-07-12 Codex): T0 CG 10/10 + T0 의상 초상 10/10, T1 좁은 방 1건 + 남산 2건 + 놀이동산 2건 + 시골의 이틀 1건 + 첫날밤 아침 2건 + 다은 프로포즈 1건 + 다은 결혼식 2변주 + 지연 결혼 격차 1건 완료.** 프로포즈는 수락 결과 문단에서만 열리고 결혼 준비 비용은 소형/풀 식장으로 지속된다. 지연 장면은 선택 전 계급 압력으로 고정했다. 다음 비주얼 큐는 `docs/ENDING_ART.md`의 P0 전용 엔딩 CG 8종이다.
