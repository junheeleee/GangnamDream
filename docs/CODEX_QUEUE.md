...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-154 · 결혼 첫날·비교본 보관 이름표 | [154](queue_active/ORDER-154.md) | exact 5 root 실제 StoryMode fail-first→hidden · 배경 묶음 전 두 사람 gate OPEN·HOLD |
| 2 | [~] | ORDER-151 · Ch5 장소·기간·카지노 맥락 | [151](queue_active/ORDER-151.md) | 042f5ea 두 경로 6/6 Codex 관찰 · 보증 충돌 수리 완료 · 배경·결혼/비교본 이름표 남음 · 두 사람 gate OPEN·HOLD |
