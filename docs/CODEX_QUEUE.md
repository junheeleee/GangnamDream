...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-123 · W9 다중 약속 선택판의 3~4개 후보를 보존해 24주 입력 정지를 복구한다 | [123](queue_active/ORDER-123.md) | 원격 KO W9 재현 · 원인/계보 확정 · 0~4 UI·terminal identity·KO/EN 24주·CI green 대기 |
