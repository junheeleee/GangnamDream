...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-94 · 서울 사이클 첫 달 수직절편 | [94](queue_active/ORDER-94.md) | 주간 여력·장소 노드·진행/위협 클록으로 계획과 수행을 하나의 반복 게임으로 증명 |
| 2 | [ ] | ORDER-95 · 참조작 전수 분석 판정표 | [95](queue_active/ORDER-95.md) | ORDER-94 뒤. 구현 없이 가져올 것·버릴 것만 판정 |
