...
**진행 상태 (2026-07-11 Codex): T0 CG 8/8 + T0 의상 초상 8/8, T1 좁은 방 1건 + 남산 2건 + 놀이동산 2건 + 시골의 이틀 1건 + 첫날밤 아침 2건 paired jobs 완료.** 첫날밤은 다은의 작은 신혼집과 지연의 고층 신혼집을 분리하고, 전날 실내복을 아침까지 유지하며 결과 문단 1에서만 CG를 공개한다. 결혼식 뒤 도달 불가 트리거를 복구했고 `t200/t205` 후반 HUD·KO/EN 크롭을 검증한다. 다음 하위 큐는 첫눈 겨울 의상과 프로포즈·결혼식/엔딩 통합이다.
