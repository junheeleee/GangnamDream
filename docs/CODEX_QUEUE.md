...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-43 · 실제 녹음/샘플 오디오 REWORK | [ORDER-43](queue_active/ORDER-43.md) | 전 사건·배경·대표 240주 자동 확산·clean RC PASS, 장별 사람 연속 청취 OPEN |
| 2 | [~] | USER-P0N · 데모 장면 연출 문법 240주 전 구간 확산 | [USER-P0N](queue_active/USER-P0N.md) | 1,565사건·960주 정적/KO·EN 240주 실주행·논리 4K PASS, 정상 속도·실기기·A/V 사람 판정 OPEN |
...
- `[x] ORDER-48` (2026-07-26): 다은의 조기 연애 확정·이혼 경첩과 핵심
  ...
  21면과 전체 감사를 통과했다.
  [완료 사양](queue_archive/ORDER-48.md)
