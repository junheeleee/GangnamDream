...
|---:|:---:|---|---|---|
| 1 | [x] | ORDER-75 · 24주 첫 청구서 연속 피날레 | [ORDER-75](queue_active/ORDER-75.md) | 기존 8방향 보존, 단일 진입 압박→결정→장부·전용 자산·읽기 전용 회상 PASS |
...
1. 데모 축 비대칭·두 번째 유혹·구간 내 대가를 재측정하고 필요한 최소 장면만 수리
