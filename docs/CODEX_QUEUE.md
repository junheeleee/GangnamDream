...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-119 · 게임 전체 플레이어 표면에서 스탯·시스템 언어 제거 | [119](queue_active/ORDER-119.md) | 구현·KO/EN 24주·KO 240주·정적 CI·ORDER-123 KO/EN 24주·최종 full audit 완료 · 원격 CI green 뒤 마감 재개 · 사용자 최종 GO OPEN |
