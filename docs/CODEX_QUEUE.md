...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-57 · Core Loop V2 데모 재구축 | [ORDER-57](queue_active/ORDER-57.md) | 24주 실제 데모 단계 계획·A0 종료/회고/계획 검토 AUTO PASS, 다음 A1 배경 루틴·실제 포기 소비·기한·관계 결과·합법 경제, 9~24주와 기본 전환은 단계 게이트 뒤 |
