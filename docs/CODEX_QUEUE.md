...
#### [~] ORDER-10 [P1] 데모 빌드 확정 + 넥스트페스트 준비 — 착수: 취업·첫 출근·부업 수입·AP 표기 모순 수리, t=24 실입력 풀런, 공식 참가 체크리스트 — 만지는 파일: `autoloads/GameState.gd`, `systems/JobSystem.gd`, `scenes/MainGame.gd`, `scenes/ArubaGame.gd`, `scenes/OpeningCinematic.gd`, `content/events/story_events.json`, `content/events_en/story_events.json`, `content/events/arc_midgame.json`, `content/events_en/arc_midgame.json`, `content/events/arc_specialization.json`, `content/events_en/arc_specialization.json`, `content/events/scenario_cafe_callback.json`, `assets/event_visual_contracts.json`, `tools/DemoBuildCheck.gd`, `tools/ScreenshotQA.gd`, `docs/NEXTFEST_CHECKLIST.md`, `docs/DEMO_QA_REPORT.md`, `docs/QA_CHECKLIST.md`, `docs/BALANCE.md`, `docs/CODEX_QUEUE.md`, `docs/WORK_LOG.md`, `docs/RELEASE_NOTES.md`, `CLAUDE.md`
