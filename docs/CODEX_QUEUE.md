...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-57 · Core Loop V2 데모 재구축 | [ORDER-57](queue_active/ORDER-57.md) | D 1~20주 AUTO PASS. E 21~24주 첫 청구서·6개월 회고와 사용자 NO-GO를 받은 시작폰 세대감 재작업 착수. 기본 전환·사람 GO는 OPEN |
