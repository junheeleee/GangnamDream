...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-57 · Core Loop V2 데모 재구축 | [ORDER-57](queue_active/ORDER-57.md) | B NO-GO 재작업: 1년·5년 정본 인과, 첫 만남 기억 소비, 동적 잔고·한국어·수치 정합성, 원자 행동·결과 저장 복구를 함께 보정 중. 기본 전환·사람 GO는 OPEN |
