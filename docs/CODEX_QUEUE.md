...
2. **6년의 처리**: 요약 대신 한 컷 — 마지막 상환 이체 확인 화면, 잔고 50만원. ("6년"이라는 단어는 여기서 한 번만.)
...
4. 흐름 확정: 콜드오픈(2031, 유지) → 고시원 기상 → **「무릎」 플래시백+선택** → 마지막 상환 한 컷 → 아버지 전화(기존 — 이제 담담함이 아프게 읽힘) → 수첩 문장 선택 → 삼각김밥. 데모 훅 자산(콜드오픈·t4 타이머)은 불변.
