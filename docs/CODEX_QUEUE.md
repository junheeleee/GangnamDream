...
**진행 상태 (2026-07-11 Codex): T0 CG 8/8 + T0 의상 초상 8/8, T1 좁은 방 1건 + 남산 2건 + 놀이동산 2건 + 시골의 이틀 1건 paired jobs 완료.** 시골 장면은 실내 기차·다은 어머니 집·밤 버스를 분리하고, 동일한 여름 사복 2종 초상과 결과 문단 1 전용 CG로 연결했다. 여름 시작/이월과 좁은 방 긴 코트의 서늘한 계절 이월을 런타임 검사한다. 다음 하위 큐는 첫날밤 아침 paired jobs다.
