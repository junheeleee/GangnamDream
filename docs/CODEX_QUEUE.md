...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-130 · 종막의 9·10·9 문단 할당량을 제거하고 장면 기능으로 재판정 | [130](queue_active/ORDER-130.md) | 선언 · ORDER-129 exact full audit GREEN 기준선 · SCENE_TIER 정본 복구·KO/EN 자연 압축·회귀 대기 |
