...
**진행 상태 (2026-07-11 Codex): T0 CG 8/8 + T0 의상 초상 8/8, T1 좁은 방 1건 + 남산 2건 paired jobs 완료.** 남산은 인물 없는 케이블카·왕돈가스 식당·실내 전망대 배경과 다은/지연별 야외 자물쇠 CG를 분리하고, 같은 의상 초상·시선 계약·정상부 물리 구조를 잠갔다. 지연의 좁은 방은 문밖 롱코트 초상과 실내 니트 초상, 정본 고시원 CG를 한 세트로 유지한다. 다음 하위 큐는 놀이동산·시골 밤 버스·첫날밤 아침 paired jobs다.
