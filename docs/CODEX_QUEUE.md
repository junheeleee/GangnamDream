...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-76 · 넓은 월간 계획판과 세로 연락폰 분리 | [ORDER-76](queue_active/ORDER-76.md) | 기종 구매를 종료하고 일정·금융을 본화면, 문자·통화만 세로폰에 둔다 |
| 2 | [ ] | ORDER-74 · 신규 데모 지식·화자 계약 | [ORDER-74](queue_active/ORDER-74.md) | 사용자 실플레이 UI 수리를 먼저 끝낸 뒤 27개 대화 계약으로 복귀 |
