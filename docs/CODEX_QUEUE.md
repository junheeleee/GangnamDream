...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-123 · W9 다중 약속 선택판의 3~4개 후보를 보존해 24주 입력 정지를 복구한다 | [123](queue_active/ORDER-123.md) | 0~4 UI·terminal identity·KO/EN 24주 완료 · 첫 full audit의 Year5·JA/ZH 파생 잠금 5플래그 수리·최종 CI green 대기 |
| 2 | [~] | ORDER-119 · 게임 전체 플레이어 표면에서 스탯·시스템 언어 제거 | [119](queue_active/ORDER-119.md) | 구현·KO/EN 24주·KO 240주·정적 CI 완료 · ORDER-123의 KO/EN 24주·원격 CI green 뒤 마감 재개 · 사용자 최종 GO OPEN |
