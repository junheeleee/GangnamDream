...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-156 · Ch5 생활 routine 실제 배경 | [156](queue_active/ORDER-156.md) | 관찰 settled frame 6회·고유 원고 5개 fail-first · 공원 배경 1 · 사람 gate OPEN·HOLD |
| 2 | [~] | ORDER-151 · Ch5 장소·기간·카지노 맥락 | [151](queue_active/ORDER-151.md) | 042f5ea 두 경로 6/6 Codex 관찰 · 보증·이름표·저작 배경 완료 · routine 수리 중 · 두 사람 gate OPEN·HOLD |
| 3 | [~] | ORDER-150 · Ch5 human REJECT 수리 | [150](queue_active/ORDER-150.md) | 후속 151 exact 재플레이 대기 · 두 사람 gate OPEN · HOLD |
| 4 | [ ] | ORDER-157 · 5장 종막의 부정 종결 습관을 푼다(사실은 유지) | [157](queue_active/ORDER-157.md) | ORDER-150 exact 제품 뒤 재계측 · 금지 사실은 한 건도 삭제 금지 · 선행 대기 |
