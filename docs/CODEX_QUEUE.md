...
|---:|:---:|---|---|---|
| 1 | [ ] | ORDER-88 · 독자 없는 아버지 기억과 24주 중복 영수증 정리 | [88](queue_active/ORDER-88.md) | 새 카드를 늘리지 않고 기존 장면 안에서 여섯 기억과 네 중복 기록을 닫기 |
| 2 | [ ] | ORDER-89 · 계획판 진행 표시를 확정 조건에 맞춘다 | [89](queue_active/ORDER-89.md) | 레일이 남은 수량을 세고 내비게이션을 한 겹으로 |
| 3 | [ ] | ORDER-90 · 판정을 주는 `유혹` 라벨을 표면에서 제거 | [90](queue_active/ORDER-90.md) | 착수 전 표면 라벨 사용자 결정 필요 |
