...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-119 · 게임 전체 플레이어 표면에서 스탯·시스템 언어 제거 | [119](queue_active/ORDER-119.md) | 36파일 범위 확정 · wrapper/raw 칭호의 시스템 언어 0 · 첫 full audit에서 stale 몰입 QA·내부 ID 오탐 확인, 검사 계약 보정 중 · 이전 후보 KO/EN 24주·KO 240주·정적 CI·ORDER-123 KO/EN 24주 완료 · 새 후보 full audit·직렬 실렌더 재실행 대기 · 사용자 최종 GO OPEN |
