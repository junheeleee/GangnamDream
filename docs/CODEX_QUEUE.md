...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-92 · 재고조사 약속 수행층 수직 슬라이스 | [92](queue_active/ORDER-92.md) | 세 요구 중 둘을 실제로 처리하고 결과 이유를 말할 수 있는지 판정 |
| 2 | [ ] | ORDER-89 · 계획판 진행 표시를 확정 조건에 맞춘다 | [89](queue_active/ORDER-89.md) | 레일이 남은 수량을 세고 내비게이션을 한 겹으로 |
| 3 | [ ] | ORDER-90 · 판정을 주는 `유혹` 라벨을 표면에서 제거 | [90](queue_active/ORDER-90.md) | 표면만 `회복`으로, 내부 kind 불변 |
| 4 | [ ] | ORDER-91 · 계획판 카드를 출처가 있는 물건으로 | [91](queue_active/ORDER-91.md) | ORDER-89 뒤 착수. 첫 달 4개 출처·물성 |
| 5 | [ ] | ORDER-88 · 독자 없는 아버지 기억과 24주 중복 영수증 정리 | [88](queue_active/ORDER-88.md) | 새 카드를 늘리지 않고 기존 장면 안에서 여섯 기억과 네 중복 기록을 닫기 |
