...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-88 · 독자 없는 아버지 기억과 24주 중복 영수증 정리 | [88](queue_active/ORDER-88.md) | 착수 — 기존 21주 건강 신호·24주 첫 청구서가 여섯 기억을 읽고, 정확 추적 영수증을 남긴 채 네 중복 기록만 퇴역 |
| 2 | [ ] | ORDER-96 · LOC-0 다의 한국어 UI 키를 안정 문맥 ID로 분리 | [96](queue_active/ORDER-96.md) | ORDER-88 종료 대기 — 2,730 legacy 키를 보존하며 28키를 30 ID·37호출로 분리 |
