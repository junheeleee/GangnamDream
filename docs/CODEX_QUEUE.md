...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-298 · 다이사이 하단 행동 버튼 잘림 수리 | [298](queue_active/ORDER-298.md) | 원본8PNG 실패 보존 · 간격 수리 착수 |
| 2 | [~] | ORDER-297 · 룰렛 선택·공유 홀짝 CN/TW 화면/입력 | [297](queue_active/ORDER-297.md) | 첫8PNG 하단 잘림 · 298 수리 후 동일40raw 재검수 |
