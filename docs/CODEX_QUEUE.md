...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-85 · 문체 | [85](queue_active/ORDER-85.md) | 72·447 전수 |
| 2 | [ ] | ORDER-84 · 1원 | [84](queue_active/ORDER-84.md) | P-10 뒤 |
...
- `[x] ORDER-74` (2026-08-03): 신규 데모 대화·메시지 27건에 화자별 지식
  ...
  바로잡았다. [사양](queue_archive/ORDER-74.md)
