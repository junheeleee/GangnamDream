...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-218 · 입력 수리 역사 지문 정합 | [218](queue_active/ORDER-218.md) | 승인 MainGame5줄 exact 전이·CI7오류 수리 |
| 2 | [~] | ORDER-217 · 선택의 후속·미응답 약속 번역 | [217](queue_active/ORDER-217.md) | 18종342문구 KO 직접 저작·독립 검수 |
