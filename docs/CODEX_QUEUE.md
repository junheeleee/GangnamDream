...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-57 · Core Loop V2 데모 재구축 | [ORDER-57](queue_active/ORDER-57.md) | B 1~12주와 휴대폰·대화 기록 AUTO PASS. C 13~16주 선제 추적·한빛 면접·돈 인물 입구의 정본/런타임/폰 채널을 구현 중. 기본 전환·사람 GO는 OPEN |
