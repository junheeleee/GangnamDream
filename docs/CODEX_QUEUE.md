...
| 10 | [~] | ORDER-43 · 실제 녹음/샘플 오디오 REWORK | [ORDER-43](queue_active/ORDER-43.md) | 장별 사람 연속 청취 |
| 11 | [~] | USER-P0N · 데모 장면 연출 문법 240주 전 구간 확산 | [USER-P0N](queue_active/USER-P0N.md) | 정상 속도·실기기·A/V 사람 판정 |
| 12 | [~] | ORDER-21 · 일본어 번역 웨이브 | [ORDER-21](queue_active/ORDER-21.md) | 데모 GO 뒤 본문 번역·15장 캡처·원어민 검수 |
| 13 | [~] | ORDER-23 · 동기 각인 수술 | [ORDER-23](queue_active/ORDER-23.md) | 동기 문장 기억 여부 사람 판정 |
| 14 | [~] | ORDER-22 · 주간 루프 몰입 수리 | [ORDER-22](queue_active/ORDER-22.md) | 정상 속도 몰입·재미 사람 판정 |
| 15 | [~] | ORDER-28 · 240주 전체 재구성 | [ORDER-28](queue_active/ORDER-28.md) | 외부 정상 독해 10인 플레이 0/10 |
| 16 | [~] | ORDER-26 · AP 의미화 | [ORDER-26](queue_active/ORDER-26.md) | 망설임·전략 재미 사람 판정 |
