...
|---:|:---:|---|---|---|
| 1 | [~] | ORDER-101 · CH1-A W1~8 온보딩·자기소개서/지원·첫 후속 | [101](queue_active/ORDER-101.md) | 착수 — fresh W1 1회 완료·pre-result restart/post-result 저장 아래 여덟 행+exact debt 12를 단일 소유권·실제 다음 동사로 증명. 사용자 L3는 W24 제품 완료 뒤 시작 |
