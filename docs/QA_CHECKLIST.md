...
- The current accepted slice is nine direct weeks (seven Decision plus two Boss), four Echoes, eleven Quiet weeks, and three summaries. One authored StoryMode boss owns week 4, so the runtime must expose eight generic AP commitments plus one story-boss commitment, never ten. The week kind is locked in serialized run state before any StoryMode round trip or automatic routine can change crisis inputs; an auto week may not mutate into a decision in the same turn. The latest scene-first references are KO PlayStation 642 and EN Xbox 646 confirms across the same 46 events, with nine total commitments, four exact Echoes, and zero keyboard/mouse events. Those numbers are regression evidence, not a fun verdict; a fresh normal-reading replay remains mandatory before release approval.
...
- `ScreenshotQA --qa=demo-experience --demo-build` must emit a machine-readable event profile for KO PlayStation and EN Xbox. `python3 tools/demo_experience_audit.py <ko.json> <en.json>` must keep the two routes at 25 roots, 40-60 events, at least 24 meaningful choices, 40-90 estimated minutes, first meaningful choice within seven minutes, maximum later choice gap within 7.5 minutes, and exact structural/visual/ambience/authored-score parity. The accepted prose baseline is 46 events, 35 meaningful choices, KO 63.1 minutes, EN 54.8 minutes, 15 backgrounds, 11 portraits, four CGs, ten place ambiences, five score keys, and seven authored score events. The route must report eight generic AP commitments, one authored story-boss commitment, nine total commitments, and 642/646 confirms. Older 19/19 AP, 689/693, 666/670, and 47-event values are historical.
