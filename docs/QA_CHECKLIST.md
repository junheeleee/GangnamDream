...
| Event visual contracts: seasonal Minjun clothing, rainy room/street split, year-close wardrobe, father phone location, restaurant/cafe callback routing, choice-result location/ambience, and flag-dependent character stages | `--qa=event-visuals --lang=ko/en` |
