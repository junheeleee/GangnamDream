...
- `peak_scene_chain_audit.py --strict` measures the 30 canonical Tier-1 roots through their actual `follow_up_event` paths. All 30 must pass and expansion debt must remain zero.
