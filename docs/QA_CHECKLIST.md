...
- `peak_scene_chain_audit.py --strict` measures the 28 canonical Tier-1 roots through their actual `follow_up_event` paths. It must preserve all 26 accepted chains and may never raise the recorded expansion debt above 2; each accepted expansion ratchets that ceiling down.
