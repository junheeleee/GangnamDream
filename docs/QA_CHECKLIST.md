...
- The current accepted slice is 9 direct weeks, 2 Bosses, 4 Echoes, 11 Quiet weeks, and 3 summaries. KO PlayStation/EN Xbox reference runs are 901/905 confirms with 18/18 direct AP and zero keyboard/mouse events. Those numbers are regression evidence, not a fun verdict; user Round 2 remains mandatory before full-game rollout.
