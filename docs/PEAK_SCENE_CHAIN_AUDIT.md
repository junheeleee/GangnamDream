...
**현재 래칫:** 28개 중 PASS 7, 확장 부채 21. `tools/audit.sh`는 부채가 21보다 늘거나 남산 두 골드 스탠다드·다은 프로포즈·다은 결혼식·지연 결혼 격차·상철 대면·아버지 병상이 퇴행하면 실패한다.
...
6. **다음:** `arc_father_passing`과 `arc_father_call_on_ktx`, 이후 첫 키스·첫날밤, 재혁, 어머니의 밥상·좁은 방, 심판·이혼, 계절 정점 순으로 부채를 낮춘다.
