...
## Unreleased
- Added a data-grounded store-tone opinion without changing the approved store page, trailer cut, or demo CTA. Five policies were rerun 3,000 times each: the equal-policy sample resolved to 57.92% material/career/status endings, 20.00% relationship endings, 22.07% collapse, and 53.60% with no close relationship; direct Gangnam or acquisition-funded 3B outcomes were about 0.23%. The 24-week demo curve was traced from the cold open and Father's knee through the burner-account peak, small work/money gains, and Daeun/Father choices. The recommendation is to use the concrete 500K/five-year/3B aspiration as the entrance while selling the game honestly as the cost of success; Korean/English three-second and demo-CTA contrast drafts remain advisory pending player approval.
