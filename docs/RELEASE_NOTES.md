...
- Converged the remaining Chapter 2, 4, and 5 micro-scenes into week-spanning consequences without adding events, IDs, or economic effects. The eighteen-month check now pays off at the end of year two; the one-billion milestone cools into isolation; the subway body warning returns six and eight weeks later as a plan review and a night of doubt; year four closes into a five-week reckoning before the final year; and the 2.5-billion property decision cannot precede the 2-billion final stretch. Both representative paths now report zero isolated micro-scenes in all five chapters, with authored stops at `27/25/26/16/13` and `29/24/32/23/15`. Seventeen private late-game scenes resolve the saved current home instead of inventing a return to the goshiwon, the Han River threshold matches its riverside image, and Father's isolation memory works whether he is alive or dead. Korean and English 28-shot late-chapter suites cover housing, subway, Hangang, remote-call presentation, milestone order, ambience, and zero English Hangul. Automated evidence does not overturn the user's narrative NO-GO.
- Compressed Chapter 1's foreground without deleting events or changing its long-run economy. First-paycheck, office-routine, and night-routine beats now retain their original effects as non-blocking bridges, and survival jobs can no longer display an invented office shift. Hyunsu's failure now follows exam, formal result, four-week aftermath, five-week drift, and six-week new path; StoryMode choices schedule deferred promises through the shared GameState path, while legacy pivot recovery cannot duplicate the new route. Every goshiwon farewell enters the first night in Minjun's live home, the beer prop costs 3,800 won instead of 30,000, and local hallway scenes are visually separated from remote messages and calls. Representative paths now stop 27/29 times with seven chains and zero isolated Chapter 1 micro-scenes. Korean and English eight-shot suites plus the demo runtime gate cover order, housing, job filtering, ambience-only playback, and localized fit. The user's narrative NO-GO remains.
