...
### Changed (2026-05-28 — 뉴스 템플릿 전면 재작성)
- **뉴스 헤드라인 79개 전부 고유 교체**: 기존 5개 반복 패턴 → 카테고리별 구체적 헤드라인
  - korean_stocks: 삼성전자 실적 쇼크, 외국인 이탈, 공매도 타깃, 회계감리 등 9개 고유
  - us_stocks: AI 수혜주 부각, 연준 발언, 실적 서프라이즈, CEO 사임 루머 등 9개 고유
  - real_estate: 강남 아파트 급등, 재건축 완화, 전세 실종, 미분양, GTX 개통 등 9개 고유
  - politics: 규제 강화, 세제 혜택 통과, 포퓰리즘 공약, 한미 협력, 검찰 수사 등 9개 고유
  - social_trends: 투자 인증 FOMO, 영끌 이자 폭탄, 파이어족, 앱테크 열풍 등 9개 고유
  - ai_boom: GPT-5 공개, 전력 수요 논란, HBM 공급 계약, AI 규제, 나스닥 상장 등 9개 고유
  - startup_culture: 시리즈C 유치, 혹한기 폐업, IPO 흥행, 감원 쇼크, M&A EXIT 등 9개 고유
  - employment_crisis: IT 취업 경쟁, 구조조정 단행, 청년 실업, AI 대체 직군 등 8개 고유
  - cryptocurrency: 폭등/폭락, 해킹, 정부 규제, ETF 기대, 반감기, 김치프리미엄 등 8개 고유
- **topics 배열 카테고리별 맞춤화**: 삼성전자/SK하이닉스(한국주식), 엔비디아/테슬라(미국주식), 강남구/잠실/재건축(부동산) 등 실제 관련 키워드로 교체
