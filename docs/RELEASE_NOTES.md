...
- Reversed the wallet-event bus-stop bench to the intended player-facing orientation. The full seat and inner backrest now read immediately in front of the shelter glass, while the rainy road remains visible and the wallet stays above the 1280x800 dialogue and choice docks.
