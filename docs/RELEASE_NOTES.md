...
- Expanded the hidden narrative cadence across all 240 weeks without changing the calendar or AP economy. The complete run now exposes 52 direct Decision/Boss weeks distributed `12/10/10/10/10` across the five chapters, seven bosses including the two demo peaks, 20 Echoes, and 21 blocking summaries; Quiet/Echo weeks execute the existing two-slot routine and all monthly economy, while real crises can promote a week before its serialized kind locks. After the late-chapter recomposition, a fixed structural audit places two representative paths' estimated two-hour line at weeks 111-116, total at 204.9-227.8 minutes, and post-demo random-event opportunities at 28-33 with at least one in every chapter; these are comparison estimates, not human playtime or a fun verdict. Legacy saves discard only stale week-kind locks, current demo saves carry into full, and 1280x800 English renders now prove canonical `Survival / Expansion / Truth / Weight / Reckoning` decision surfaces with Seoul Trace intact after the first month.
