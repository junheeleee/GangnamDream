...
## Unreleased
- Replaced the remaining recurring AP pictogram treatment with image-first Gangnam Ink scene strips. New social/risk and gambling atlases give People, Gambling, Routine, Date, Racetrack, Hold'em, Scalp Trading, and Jeongseon Casino distinct physical scenes; weekly cards now use 112x84 art and action modals use 108x56 art. A thumbnail-specific Moral material preserves readable props at Gray while retaining Black corrosion and White color recovery. Korean/English AP QA now captures the gambling selector and asserts all four venue regions.
...
- Extended the Gangnam Ink AP illustration system with twelve distinct submenu scenes: cover-letter writing, mock interviewing, gig work, saving, market analysis, startup work, content creation, moving house, reading, exercise, meditation, and investment study. Function-level mapping prevents broad money/job icons from collapsing different actions into the same picture, while KO/EN AP QA now captures Work and Self-Dev modals and asserts distinct atlas regions for Work, Money, Living, and all four study choices.
- Replaced the four recurring AP category pictograms with a dedicated Gangnam Ink illustration atlas: resume and ID for work, a market phone for money, books and exercise tools for self-development, and the canonical goshiwon window for rest. The wider 76x48 crops participate in Moral Tint without moving controller focus; unrelated submenu actions retain distinct symbols instead of repeating one generic money image. Korean and English 1280x800 AP QA now asserts that all four atlas regions actually load.
