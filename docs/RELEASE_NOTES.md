...
## Unreleased
- Added a deterministic strategy-convergence gate covering 15,000 modeled five-year lives across safe career, aggressive investment, people-first, pure gambling, and founder play. It records asset distributions, body and mind, relationships, money/human weeks, Moral Tint, expertise, addiction, and projected ending identity while preserving all existing economy bands. Salary-only play still reaches 3B in 0% of runs by design. The audit found no hidden catch-up system, corrected its own missing Addiction-90 immediate ending, and isolated two real identity blockers: investment mastery is swallowed by the earlier career ending, while a live 3.2B startup acquisition is swallowed by the generic Gangnam branch. No gameplay numbers changed in this diagnostic pass.
