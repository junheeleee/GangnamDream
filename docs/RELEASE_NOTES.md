...
## Unreleased
- Rebuilt Daeun's wedding as a three-link climax with two meaningful decisions while preserving the existing small/full costs, routes, final effects, and save fallback. Minjun now enters first and waits at the altar; Daeun enters later through the rear doors and walks toward him. Both wedding CG variants share the same readable geography: empty groom seating on screen-left, full bride seating on screen-right, and Daeun's canonical 33-year-old face, short layered hair, left-temple pin, adult proportions, and gaze toward Minjun. Korean/English 27-shot rendering covers the entire chain, long choices, result cards, variant persistence, and final-only completion flag; Tier-1 expansion debt drops from 25 to 24.
