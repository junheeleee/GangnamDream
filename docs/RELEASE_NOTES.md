...
## Unreleased
- Expanded Moral Tint from color grading into a hidden perception system. Events and choices can now preserve the same facts while changing what Minjun notices and how he rationalizes an action; the first KO/EN vertical slice makes Black notice a receipt and spending, Gray notice Daeun's gaze, and White notice wear and worry. Black also pushes people subtly toward the frame edge and lowers lived ambience while preserving readability, with schema, localization, audio-continuity, and screenshot gates.
