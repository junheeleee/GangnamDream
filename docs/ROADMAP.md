...
- [~] T1 로맨스 비주얼 페어링 — 좁은 방·남산·놀이동산·시골 밤 버스·첫날밤 아침 완료, 프로포즈·결혼식/엔딩 통합 남음 (2026-07-11)
...
- [x] 반복 이벤트 비주얼 계약 — 54개 계절/장소/의상/인물/CG 잠금, 연말·상철·현수·카페 이중 인물·버스정류장·붕어빵·설날 완료, strict 부채 0 (2026-07-12)
