...
- 엔딩 `with_daeun`, `late_call`, `instant_legend`의 언어별22 번역 leaf와
  ...
  주거·건강25종176 leaf/locale와 직장·구직25종194 leaf/locale와 생활비25종186 leaf/locale와 가족25종172 leaf/locale와 생활 전환25종178 leaf/locale와 생활·숨은 사건25종198 leaf/locale와 회상·첫 생활25종158 leaf/locale와 후반 이정표·갈림길25종189 leaf/locale까지 총16,524번역이다
  (언어별 엔딩234+사건4,440+catalog834). catalog 신규 작성2,485·
