...
- 현재 비보호 shipping 사건의 텍스트 결손은0이다. 초기 코어22종140문구/언어를
  ...
  준비 상태 연결5를 통과했지만 실제 CN/TW 고정6glyph는 각각6/6·ready=false다.
  별도 잔여는 원장16자리표와 full SHA 요구의 불일치다. 승인 TTF/OFL 원형은 같으며
  실제 렌더·라이선스 위반 판정이 아니다. 다음 별도 원장 보강 전까지 blocked다.
