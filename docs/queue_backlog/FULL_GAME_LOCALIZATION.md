...
- 엔딩 `with_daeun`, `late_call`, `instant_legend`의 언어별22 번역 leaf와
  ...
  마지막 해40사건358 leaf/locale까지 총7,866번역이다(언어별 엔딩234+사건1,554+catalog834). catalog 신규 작성2,485·
  ...
  마지막 해40종은 조건14와 reader78/언어를 포함하며 종막15종197 leaf/언어는
  다음 묶음이다. 이 정적 연결도 해당 기간의 모든 무작위 사건·UI 번역 완료가 아니다.
