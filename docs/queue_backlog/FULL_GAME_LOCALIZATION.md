...
- 현재 비보호 shipping 사건은 언어별42종256문구가 남는다. 다음 후보는
  이스터에그8종48문구와 초기 코어12종68문구이며, 원문 사전조사만 완료했고
  아직 번역·수용한 수가 아니다. 후반 midgame/NG+ 번역은 가정/과거 경험과
