...
전체38818 L1은 오류0/72.929초/1193 불변이다. 첫 named11은10PASS/1FAIL로
보존했다(내부1574·외부1193 불변). ZH 직접 UI 감사의 같은 수량 오류2와 self 재보고2는
별도252로 연결 수리한다.250/251 최종 GO는 아직 없으며 번역54·실제405는 변경하지 않는다.
