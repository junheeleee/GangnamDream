...
구현 뒤 CN100 leaf fingerprint:
`98b443122569e285f516eb6f378251f807aef15696e00b468843b982329c3bd1`.
이 값은 작업 소스의 정적 보존선이지 기존 배포판의 번역 해시가 아니다.

독립 검토는 c3c7224 대비 파일 전체가 위1회 치환과 정확히 같음을 확인했다.
현재 문장 정상, 수량 누락/2→3 변이는 예상대로 통과/거부됐다. public 세 언어
14/100·UI121·catalog1 검사와 self-test도 통과했다. 기존 수용/본편 원장 숫자는
늘리지 않았고 원어민/실제 화면 판정은 OPEN이라 `[~]`를 유지한다.
