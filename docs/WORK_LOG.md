...
- 현재 비교 모델을 다섯 정책마다 3,000회, 총 15,000표본으로 다시 실행했다. 동일 가중 표본은 물질·직업·평판 성취 57.92%, 관계 중심 결말 20.00%, 파멸 22.07%였고 53.60%가 가까운 관계 없이 끝났다. 직접 강남 또는 창업 인수로 30억 이상에 닿은 표본은 약 0.23%였다.
