...
- 영문 1280×720·1280×800·3840×2160 Display Matrix와 1280×800 Story 전용 30컷을 렌더했다. AP 압박 카드, CG 선택지, 장면 본문, 결과 배지에 이중상·번짐·잘림·TV 안전영역 침범이 없었다. Pretendard는 데모 요구를 충족하므로 유료 디스플레이 폰트는 외부 브랜드 회상 테스트 전까지 구매하지 않는다.
