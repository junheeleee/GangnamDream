...
- 바카라/룰렛 준비안내44값의 실제30화면·188 raw는292에서 검수했고 정착 패드 잔액 잘림은293에서 수리했다. 다음 후보는 금액·총수령·미납 수수료·손익 부모18키/CN·TW36값이다. 잔액의 JeongseonCasino 공유 소비자도 포함하며 새 큐 선언 후 저작한다. raw player/banker/tie 로그·Odd/Even 공유 부모·직접영어는 별도다.
- 공유6소비자·JA/KO/EN 화면, AA 추가 카드·net0 타이 설명·EV 주장은 별도 범위다. 분할 double 원금만288에서 실제 재현·수리했다. 다른 정적 결손을 실행 재현이나 수리 완료로 부르지 않는다.
- UI사전3028 중 CN/TW각2024키 부재는 전체 live UI 분모가 아니다. 새 producer/consumer와 파일 소유를 큐에 선언한 뒤 진행한다.
