...
- `[x] ORDER-130` (2026-08-26): ORDER-129가 사용자의 “중요 장면은 10까지도
  ...
  25억/30억 중립 사실, 독립 진입, 선택문에 드러난 자기평가, 허위 계약·회복
  금지를 18개 mutation으로 고정했다. 현재 `6/8/6`은 새 목표치가 아니다.
  ORDER-129의 서명 coda 72/33은 보존하며, 마지막 연락의 실제 actor binding은
  Chapter 5 영수증 뒤 후속 P0다. [사양](ORDER-130.md)
- `[x] ORDER-129` (2026-08-25): M59 부동산 문턱, M60 마지막 서명, 마지막 주
  선발신을 KO/EN `9/10/9` 의미 비트와 선택 결과 4비트로 개작했다. 25억대
  매물·25억+ 자산을 30억 달성·매입·등기·열쇠로 오인시키지 않고, 답장·만남·
  용서·화해도 발명하지 않는다. 마지막 서명은 정규 엔딩 24개에서만 사람들의
  이후 첫 카드로 회수되며 실패 5개, 33세 비밀 엔딩, M60 비소유 특수 5개는
  제외한다. 35 ID·전용 CG·15 route와 첫-true 본문은 보존했고 적용 72·제외 33,
  peak 32/32, 66 script compile와 exact 전체 감사가 통과했다.
  [사양](ORDER-129.md), [계약](../ENDING_CONTRACT.md)
...
- `[x] ORDER-127` (2026-08-25): 33세·1장의 현재 순자산 30억은
  ...
  분리했다. 달성 후 하락은 기존 `peak_asset`이 보존하며,
  15개 실행 경로·35 엔딩·240주 A/V·66 스크립트 컴파일을 통과했다.
  전체 감사 13 flag는 마감으로 해소된 STATUS 1, 기존 불일치 11, 새 종막
  의미를 못 따라온 PEAK guard 1이었다. 초기 ‘전부 기존’ 기록은 정정했고
  남은 12건은 ORDER-128로 이관했다. [사양](ORDER-127.md)
