...
- `10`은 다른 장면에 적용할 길이 할당량이 아니다. 이 장면에서는 같은 밤의 연속,
  두 장부, 빈 줄, 세 의미, 포기되는 두 선택, 펜, 결정 이후의 비용이 서로 다른
  기능을 가져 10비트를 유지했다. 이후 장면은 필요한 의미 전환 수부터 정한다.
- 구현 `cd147f6f002e57ed11436466a37f2fd70336fc91` / tree
  `3eac06f9920a60a09941b62660e62b3324e1b913`에서 peak `32/32`, Year5
