...
- Recurring AP categories and high-frequency subactions use object-focused mini illustrations rather than generic clip-art pictograms. They are small world fragments, not decorative scenic backgrounds: work=resume/ID, money=market phone, self-development=books/body, rest=goshiwon window/blanket; each career, money, study, and housing subaction owns a distinct prop composition.
