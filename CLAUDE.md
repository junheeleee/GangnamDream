...
| 바로 다음 | 중반 생활20종169문구/언어의 세 언어 직접 번역·비저자 전량 검수를 시작한다. 현재 수용36,076(JA12,024·CN/TW각12,026), 잔여84종622문구/언어·UI·표시 소비자는 미완료다. 이전 중국어 연말 생성기 수리는 별도 완료이며 재실행하지 않는다. 공개 데모·인간 원형·본편 HOLD를 유지한다. |
