...
| 항목 | 내용 |
|---|---|
| **단계** | **스팀 출시 준비** — 이미지·오디오 보강 필요 |
| **최근 완료** | Steam 스토어 페이지 소재 완성 (`docs/STEAM_PAGE.md`) — 태그라인·Short/Full Description·태그 스택·캡슐 아트 방향·스크린샷 계획·가격 전략 |
...
| **마지막 업데이트** | 2026-06-11 (스팀 페이지 소재 완성) |
