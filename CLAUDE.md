...
| 바로 다음 | 수용38,155(JA12,717·CN/TW각12,719)을 보존하고 엔딩 기록19단위·UI52키를 세 언어로 직접 대조·번역한다. 기존JA52와 CN/TW신규104를 구분하며 엔딩·기록·동적 소비자와 공개 언어는 바꾸지 않는다. 남은 UI·화면·원어민 검수와 본편HOLD·인간/공개 원형을 보존한다. |
