...
| **최근 진행** | **2026-07-17 (Codex)** — ORDER-24의 다은·지연 첫날밤을 각각 3링크·2선택점 정점으로 확장했다. 신혼집·실내복을 끝까지 유지하고 앞 링크 무효과, 존엄 페이드, 다음 아침 문단에서만 열리는 CG와 원형 최종 효과를 한영 32컷·상태 검사로 잠가 정점 부채를 15로 낮췄다. |
...
| **다음 작업** | **ORDER-24 정점 체인 `[~]`** — 재혁 ghost·거울을 먼저 체인화하고, 좁은 방/밥상·심판/이혼·계절 정점 순으로 확장 부채를 낮춘다. |
| **마지막 업데이트** | 2026-07-17 (Codex: ORDER-24 첫날밤 2종 완료, 다음 재혁 2종) |
...
- 전체 카탈로그 1,519개 중 작성형 342, 랜덤 풀 1,177. 대표 경로 작성 비트는 117/120개이며 연차 분포는 `46/29/14/16/12`, `46/27/16/19/12`로 Y1 과밀·Y5 희박이 재확인됐다.
