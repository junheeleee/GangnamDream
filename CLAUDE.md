...
| 바로 다음 | M01~M06 선택 전 표면에서 정확한 완료·놓침 효과를 걷어 낸 `.2` 체험판을 다시 플레이한다. 행동·축·마감·한 번 미룸 가능 여부만 미리 알리고 미래 문은 실제로 닥칠 때 드러낸다. 사람 GO 전에는 기존 24주에 이관하지 않는다. |
...
| 마지막 갱신 | 2026-08-15 (Codex: M01~M06 스포일러 제거판 L3 재판정 대기) |
