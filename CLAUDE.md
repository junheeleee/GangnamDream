...
| 바로 다음 | 이스터에그·초기 코어20종116문구/언어를 직접 번역·독립 전량 대조·수용해 현재37,522(JA12,506·CN/TW각12,508)이다. 기존 수용 전량 회귀 오류0·지정12 통과. 다음 비보호 사건22종140문구/언어는 원문 전량 사전조사만 완료했고 UI·표시 소비자도 미완료다. 공개 데모·인간 원형·본편 HOLD를 유지한다. |
