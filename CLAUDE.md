...
| 최근 완료 | Chapter 4 M39~M48의 `StoryMode` 선택·영수증·후속을 W157~W193에 연결하고 아버지 생사 시간선을 단조화했다. `author_only` 25편을 제품에 승격해 packaged/shipping/author-only `1786/1656/130`으로 재분류했으며 30억 즉시 비밀 엔딩은 보존했다. |
| 바로 다음 | 갤러리 재생을 최초 관람 당시 상태로 고정한다. 이어 Chapter 5 M49~M59의 실제 인물·계약·대화 영수증과 M60·`arc_final_week` actor binding을 연결한다. |
...
| 마지막 갱신 | 2026-08-26 (Codex: Chapter 4 선택·아버지 단일 시간선 완료) |
