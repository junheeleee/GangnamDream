...
| 바로 다음 | 공식 수용38,944(JA12,980·CN/TW각12,982)/b104/meta9다. 보너스7키·상단버튼1키의 세 언어24를 독립 검토해 CN/TW각8을 적용하고 JA8은 유지했다. 같은Button 언어갱신과 source4 B2도 적용했으며 첫post20·실제545·공식24수용은 아직 전이다. 이전520/255 단위GO를 새 실행으로 세지 않는다. 공개GO1·인간OPEN45·본편HOLD 유지. |
