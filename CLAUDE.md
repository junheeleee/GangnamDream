...
| **최근 진행** | **2026-07-17 (Codex)** — ORDER-34 이벤트 중 장면 설정 허브에 착수했다. 기존 오디오·동작 감소 패널에 글자 크기 3단계와 한영 즉시 전환을 더하되 현재 문단·선택·타이머·음원 위치를 보존한다. |
...
| **다음 작업** | **ORDER-34 장면 설정 허브 `[~]`** — 글자 크기·사운드·언어·동작 감소를 이벤트 중 즉시 적용하고 장면 상태/오디오 연속성을 실증한다. |
| **마지막 업데이트** | 2026-07-17 (Codex: ORDER-34 이벤트 중 장면 설정 허브 착수) |
