...
| 바로 다음 | 수용38,437(JA12,811·CN/TW각12,813)을 보존했다. 승인된 중국어 폰트 full SHA2와 고지 원장 지문을 맞췄고, 독립 대조16·표적6 및 실제 정적 CN/TW 각6/6·ready=true를 확인했다. 다음은 남은 UI·동적 표시·관계 이름 소비자 수리와 별도 실제 화면 검증이다. 공개 데모·인간 원형·본편 HOLD는 그대로다. |
