...
| **최근 완료** | **2026-07-12** — **AP 핵심 행동 일러스트 아틀라스**: 웹/모바일 클립아트처럼 보이던 일·돈·자기계발·휴식 픽토그램을 이력서/사원증·시세 휴대폰·책/운동 도구·고시원 창 오브젝트 장면으로 교체했다. 76x48 크롭은 MORAL_TINT를 받되 카드와 패드 포커스는 움직이지 않는다. 투자 이미지를 부업·절약에 반복하지 않도록 대표 행동에만 매핑하고 KO/EN AP 각 22장, KO moral 12장, 네 영역 자동 로드 단언으로 검증했다. |
...
| **마지막 업데이트** | 2026-07-12 (Codex: AP 핵심 행동 Gangnam Ink 일러스트 아틀라스) |
