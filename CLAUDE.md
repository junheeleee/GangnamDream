...
| 항목 | 내용 |
|---|---|
| **단계** | **스팀 출시 준비** — 에셋 완비 확인 완료 |
| **최근 완료** | **에셋 완비 확인** — 이미지(44종 + 보너스 CG/조연), 오디오(BGM 7트랙·SFX 14종) 전부 존재. ImageRegistry 경로 전수 검증 OK. 감사 9종+CI 커밋 완료 |
| **다음 작업** | **QA 플레이스루** (로컬 Godot 필요): 실행 후 스크립트 에러·UI 레이아웃·클릭 흐름 검증. 또는 **콘텐츠 추가**: 현재 이벤트 395개 → 스팀 인디 기준 최소 500개 목표로 상황 이벤트 추가 |
| **마지막 업데이트** | 2026-06-11 (에셋 완비 확인) |
