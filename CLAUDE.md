...
| 항목 | 내용 |
|---|---|
| **단계** | **스팀 출시 준비** — 영어 로컬라이제이션 인프라 완료 |
| **최근 완료** | **영어 로컬라이제이션 인프라** — LocaleManager autoload, DataRegistry EN 오버레이, 설정 팝업 언어 토글, 오프닝 5개 이벤트 영어 번역 완료 |
| **다음 작업** | **영어 번역 2차**: 현재 35개 번역 완료. arc_events·relationship 나머지·amb_scenarios 주요 이벤트 추가 번역. 또는 **콘텐츠 추가**: 이벤트 ~450개 → 500개 목표 |
| **마지막 업데이트** | 2026-06-11 (영어 로컬라이제이션 인프라) |
