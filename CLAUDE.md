...
| 항목 | 내용 |
|---|---|
| **단계** | **스팀 출시 준비** — UX 감사 기반 개선 1~5차 완료 |
| **최근 완료** | **QA 6차**: 세이브 버그 2종, 엔딩 9종 활성화, 아크 베팅 결과 내러티브 4종. **난이도 조정(5차)**: 드리프트 0.6%/월, 기회이벤트 버프(상철+지연), 신규 투자이벤트 2종(IPO+재개발), SimRun OPP 재보정. |
| **다음 작업** | (1) 영어 로컬라이제이션 준비 (대형, 나중에) (2) 인게임 에셋 QA (로컬 Godot 필요) — 빌드: `./tools/build.sh linux` / `./tools/build.sh windows` (3) 에셋 작업: 미니게임 BGM·CG 추가 |
| **마지막 업데이트** | 2026-06-10 (문서 패스 완료: README.md·README_KR.md·BALANCE.md·DECISIONS.md·ROADMAP.md) |
