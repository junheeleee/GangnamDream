...
| **최근 진행** | **2026-07-17 (Codex)** — 프롤로그 선택 결과 위를 가리던 능력치/호감도 튜토리얼 모달을 제거하고, 시스템 설명을 첫 AP 통합 안내로만 이동했다. 실제 결과·후속·AP 안내 런타임 게이트를 잠갔다. |
| **이전 주요** | **2026-07-16 (Codex)** — ORDER-32를 완료했다. 실제 랜덤 추첨 1,045개를 5챕터·5자산 밴드·직업·주거·관계로 편성하고, 1,042개 1회/런·3개 제한 반복·저장 이력 계약을 잠갔다. 전체 이력 → `docs/WORK_LOG.md` |
| **다음 작업** | **ORDER-33 텍스트 깊이와 재질 패스 `[ ]`** — 본문 가독성은 보존하고 장면 제목·핵심 금액·선택지·상태 변화에만 얕은 잉크 깊이와 짧은 재질 모션을 적용한다. |
| **마지막 업데이트** | 2026-07-17 (Codex: 프롤로그 튜토리얼 침범 수리 완료) |
