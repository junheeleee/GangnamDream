...
| 바로 다음 | 선택 회수·목표 재고23종531문구를 더해 세 언어 총34,242번역을 수용했다(각11,414). 엔딩35종·사건1,528종·catalog834문구/locale다. 남은 비보호 사건166종과 UI·표시 소비자는 미완료 원장에서 관리한다. 다음 인물 서사19종은 사전 검토 중이며 미수용이다. 기존 선택 미리보기 일본어 건강/정신 소비자 수리는 유지하며 실제 원어민·화면·본편 전체 판정은 별도다. |
