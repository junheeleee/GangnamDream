...
| **최근 완료** | **주 단위 전환 버그 픽스** (2026-06-15) — _begin_month() crisis/뉴스 month==1 guard, 칭호 조건 turn<=4 보정. 이전: 주 단위 전환+비녜트+IS_DEMO 프레임. |
| **다음 작업** | **이벤트 flag 체인 24턴 튜닝** — follow_up 쿨다운 검토해 6개월 안에 선택 메아리 발동 보장. 이후 스탯 게이트 설계 또는 투자 미니게임 폴리시. |
| **마지막 업데이트** | 2026-06-15 |
