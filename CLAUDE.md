...
| 바로 다음 | 직장·전문화19종378문구를 더해 세 언어 총33,711번역을 수용했다(각11,237). 엔딩35종·사건1,505종·catalog834문구/locale이며 남은 비보호 사건189종과 UI·표시 소비자는 미완료 원장에서 관리한다. 선택 미리보기는 기존 일본어 건강/정신 번역을 소비하도록 고쳤다. 다음 번역 권고는 선택 회수·목표 재고23종177문구/언어이며 아직 미수용이다. 실제 원어민·화면·본편 전체 판정은 별도다. |
...
| 그다음 | 이전 원격 CI의 설치 ZIP을 runner.temp로 격리했으며, dirty 소스 검사는 유지한다. 새 원격 결과는 별도 확인한다. 이후 전체판 번역의 미완료 원장에서 후속 배치를 발급하고 Chapter 5·종막·프롤로그와 사람 게이트는 큐에 보존한다. |
...
| 마지막 갱신 | 2026-09-09 (개발·최종 내부 검수 위임 반영 / 전체판 세 언어 번역·입력 수리 / 인간 증거 원형 보존·본편 HOLD) |
