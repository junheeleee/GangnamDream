...
| **마지막 업데이트** | 2026-06-22 (PC/Steam Deck 공통 Readability Pass 2: 룰렛 숫자 매트 버튼/포커스/상태 배지 확대, 투자 자산 목록 카드화, 상점 아이템 카드화, `_open_modal()` 스크롤 리셋 및 760×610 기본값 복원, `ScreenshotQA`에 투자 자산 카드 캡처 추가. 전체 ScreenshotQA 확인.) |
