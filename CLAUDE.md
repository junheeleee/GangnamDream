...
| 최근 완료 | ORDER-153에서 legacy 익명 보증 뿌리 1개와 callback 2개를 W192까지 보존하고 W193 이후 닫아, Property W209~W212 재혁 보증선과 W238 작성형 영수증이 다시 익명 사건에 덮이지 않게 했다. KO/EN·예전 저장 왕복·W192/W193/W237/W238 경계와 변경 범위 73개를 통과했다. 원고·재혁선·W238·공개 M01~M06은 불변이며 새 전체 후보나 제품 GO는 발급하지 않았다. |
| 바로 다음 | ORDER-154로 결혼 첫날 네 장면과 M51 비교본 보관 장면의 혼합 대화 이름표를 숨긴다. 정확한 다섯 event id에만 표시 계약을 추가하고 실제 StoryMode에서 KO/EN·분기·결과까지 거짓 화자명이 없는지 확장 검증한다. 이후 남은 배경 불일치도 독립 묶음으로 닫으며, 이름표와 배경이 모두 닫힌 새 exact 후보 전에는 플레이를 요청하지 않는다. 사람 gate OPEN·전체 HOLD다. |
...
| 마지막 갱신 | 2026-09-05 (ORDER-153 legacy 보증 재진입 차단 완료 / ORDER-154 혼합 대화 이름표 수리 다음 / 사람 gate OPEN·본편 HOLD) |
