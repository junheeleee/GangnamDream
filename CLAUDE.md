...
| 바로 다음 | 선택 후속·미응답 약속18종342문구를 더해 세 언어 총33,333번역을 수용했다(각11,111). 엔딩35종·사건1,486종·catalog834문구/locale이며 남은 사건208종과 UI·표시 소비자는 미완료 원장에서 관리한다. 자각 알림의 승인된 입력 수리와 역사 소스 지문을 연결했다. 다음 번역 권고는 직장의 선택·전문화19종126문구/언어이며 아직 미수용이다. 실제 원어민·화면·본편 전체 판정은 별도다. |
