...
| 바로 다음 | 전체판 일본어·간체·번체에서 엔딩35종·사건528개·catalog834문구씩, 총15,483번역을 원문 대조·수용했다. 비표시 메타9와 기존 번역을 보존하며 생활·숨은 사건25종을 더했다. 다은 일본어 존대 복구도 유지했다. 검수 대기는 단일 큐의 이어보기로 남기고, 미완료 원장에서 다음 스토리 배치를 이어간다. 배경 제품 `53493fe`는 별도 보존, 입력 QA 잔여·사람 gate OPEN·전체 HOLD다. |
