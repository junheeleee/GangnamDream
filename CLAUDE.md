...
| 바로 다음 | 경마 거리 단위 검사 오탐을 수리해 기존 중국어20값 복구수용. 보류110→90, 원고 재저작0. 공식39,892/b118/meta9. 비보호 shipping 사건11,578 세 언어 수용 완료, 잔여843은 참고741·보호102. UI 사전3015키 중 CN/TW각2146키 부재(전체 UI 분모 아님). 초안9월23일은 연속 작업 전제 추정, 검수·출시 약속 아님. 첫고지본문·나머지 보류·UI는 큐 참조. 공개GO1·인간OPEN45·본편HOLD 유지. |
