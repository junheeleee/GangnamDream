...
| 바로 다음 | 관계 패널30키의 세 언어90을 추가 수용해38,587(JA12,861·CN/TW각12,863)이다. 소개팅·썸·전 연인의 태그를 중립화하고 옛 행동판 안내를 고쳤다. 실제 component80·기존65 회귀가 통과했고 저장·효과는 그대로다. 다음은 실제 표시 소비자의 언어 분기와 남은 UI를 수리한다. 실제 렌더·원어민·전체판 검수는 별도이며 공개 데모·인간 원형·본편 HOLD를 유지한다. |
