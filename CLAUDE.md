...
| 바로 다음 | 공식39,292/b112/meta9. 기록 수리 뒤 중국어 UI 초안 우선. 비보호 shipping 사건11,578은 세 언어 수용 완료. 잔여843은 참고741·보호 데모102로 활성 번역 공백이 아니다. UI 사전3015키 중 CN/TW각2446키가 없다(전체 UI 분모 아님). 분모·판정은 번역 backlog·큐 참조. 초안9월23일은 연속 작업 전제의 추정이며 검수·출시 약속이 아니다. 공개GO1·인간OPEN45·본편HOLD 유지. |
