...
| **다음 작업** | **ORDER-29 StoryMode 수직 슬라이스** — 비·눈·안개/기억·도시 빛·불꽃, 미세 카메라/초상 호흡, 선택적 배경 blur를 공통 Living Scene 계층으로 구현하고 1080p KO/EN·패드·픽셀 게이트로 검증한다. |
| **마지막 업데이트** | 2026-07-16 (Codex: ORDER-29 Living Scene 파일 범위 선언) |
