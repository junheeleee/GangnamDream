...
| 바로 다음 | 기록 불러오기 UI24키×3을 직접 대조·수용해38,014(JA12,670·CN/TW각12,672)다. JA기존24 검수·2정밀화와 CN/TW신규48을 구분한다. 비보호 shipping 사건 텍스트 결손0을 보존하며 남은 UI·표시 소비자·실제 화면·원어민을 계속 검수한다. 공개 데모·인간 원형·본편 HOLD 유지. |
