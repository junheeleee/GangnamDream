...
| 바로 다음 | 공식39,265(JA13,087·CN/TW13,089)/b111/meta9. 카드·생각정리54 수용·독립검수·회귀를 마감했다. 새 게임의 출발 상태·소식 기록에 남은 영어 직행을 실제 생성자와 함께 고친다. 기존 원장·KO/EN·게임 상태·저장 보존, exact 단위판정은 큐가 소유한다. 실제화면·원어민 미관측, 공개GO1·인간OPEN45·본편HOLD 유지. |
