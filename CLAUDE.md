...
| 항목 | 내용 |
|---|---|
| **단계** | **스팀 출시 준비** — 아크 깊이 + 패널 완성 + 경고 분기 |
| **최근 완료** | **arc_jiyeon_truth_warned 신설** (warned_about_jiyeon → 다른 진실 씬), **아버지·재혁 아크 패널 추가** (누락됐던 두 주요 아크 패널 항목), **임상철 패널 힌트 수정**. audit ERROR 0 유지. |
| **다음 작업** | QA 플레이스루 (로컬 Godot 필요) — 전체 아크 흐름·선택 연결·엔딩 확인 |
| **마지막 업데이트** | 2026-06-10 (아크 패널 완성 + 경고 수용 분기 신설) |
