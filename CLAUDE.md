...
| 바로 다음 | 블랙잭 중국어 HUD2키 수용·표시 검수는 WORK_LOG 참조. 블랙잭·바카라 한정 정산 수리 완료. 공식40,133/b131/meta9·보류72 유지. 비보호 shipping 사건11,578 세 언어 수용, 잔여843은 참고741·보호102. UI 사전3028키 중 CN/TW각2046키 부재(전체 live UI 분모 아님). 남은 UI·보류 수리는 큐 참조하며 번역 전체 완료일은 확정하지 않는다. 공개GO1·인간OPEN45·본편HOLD 유지. |
