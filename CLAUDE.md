...
| 바로 다음 | ORDER-153으로 Property W237에 느직게 등장한 익명 고교 친구 보증을 M53 W209~W212 재혁 보증선과 분리한다. 익명 사건과 두 callback은 W192까지 보존하고 W193 이후 재진입만 차단하며, 재혁 원고·W238 회수·예전 세이브·공개 M01~M06은 불변으로 검증한다. 남은 배경·결혼/비교본 이름표까지 닫은 새 exact 후보 전에는 플레이를 요청하지 않는다. 사람 gate OPEN·전체 HOLD다. |
...
| 마지막 갱신 | 2026-09-05 (ORDER-153 W237 익명 보증 충돌 수리 선언 / 사람 gate OPEN·본편 HOLD) |
