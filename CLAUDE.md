...
| 항목 | 내용 |
|---|---|
| **단계** | **스팀 출시 준비** — 콘텐츠 500개 달성, 콘텐츠 경고 추가 |
| **최근 완료** | **이벤트 500개 달성** — life_events2(19) + amb_scenarios7(10) + drama_events2(15) + relationship_events2(10) + EN 오버레이 4파일. 콘텐츠 경고 모달 StartMenu 추가. |
| **다음 작업** | **QA 플레이스루** (로컬 Godot 필요) — EN/KO 모드 클릭 흐름·번역 자연스러움 검증. 또는 **스토어 페이지 소재** (스크린샷, 설명문, 태그) |
| **마지막 업데이트** | 2026-06-12 (이벤트 500개 + 콘텐츠 경고) |
