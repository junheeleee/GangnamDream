...
| 최근 완료 | 3개월차의 얕은 결과 카드를 고시원에서 영수증·수첩을 맞대는 `방 안의 장부`로, 4개월차 주거복지 상담을 이사 뒤 현금·혼자 있을 공간·이동시간 중 방의 기준을 고르는 주민센터 장면으로 바꿨다. 선택은 수치를 바꾸지 않고 1년·5년 뒤 서로 다른 의미로 돌아오며, AP·효과·저장은 한 번만 적용된다. 실제 24주 현지화 범위는 `72사건 / 447본문 / 동적 543회·536고유`다. 한국어 960×600·영어 1280×800 장면과 옛 저장 회귀는 자동 통과했지만 생활감·장기 여운은 사람 판정으로 남겼다. |
