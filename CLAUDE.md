...
| **최근 완료** | **2026-06-30** — **Codex Primary CTA Surface Pass**: 데모 종료/위시리스트 주 CTA가 순백 웹 버튼처럼 떠 보이던 문제 수정. `_primary_cta_button()`을 어두운 잉크 버튼, 밝은 좌측 스트립, 얇은 포커스 테두리 중심으로 재정의해 모노톤 고급화 방향과 맞췄다. `tools/audit.sh`, `ScreenshotQA --qa=demo-end-en` 직접 확인. |
...
| **마지막 업데이트** | 2026-06-30 (Codex: Primary CTA Surface Pass — 데모 종료/위시리스트 주 CTA 버튼 질감 보정.) |
