...
| **최근 완료** | **2026-07-12** — **AP 이미지 우선 장면 스트립**: 작은 픽토그램 프레임으로 보이던 AP 그림을 주간 112x84/모달 108x56 장면 스트립으로 확대하고, 사람·도박·루틴·데이트와 경마·홀덤·스캘핑·정선 카지노 전용 아틀라스를 추가했다. 작은 이미지 전용 Moral 재질로 Gray 중간톤을 보존하며 Black/White 변주를 유지했고 KO/EN AP 각 25장+EN ACT 8장으로 패드·무스크롤·서로 다른 영역을 검증했다. |
...
| **마지막 업데이트** | 2026-07-12 (Codex: AP 픽토그램을 이미지 우선 장면 스트립으로 교체) |
