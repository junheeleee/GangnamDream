...
| **마지막 업데이트** | 2026-06-29 (Codex: English Surface + Ending Art Governance Pass — 영어 표면 캡처 QA 추가, 엔딩 카드 UI와 34엔딩 CG 우선순위 문서 갱신.) |
