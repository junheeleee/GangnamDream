...
| 바로 다음 | 갤러리20단위·UI27키×3을 직접 대조·수용해38,095(JA12,697·CN/TW각12,699)다. JA기존27 검수·3정밀화와 CN/TW신규54를 구분한다. 남은 UI·표시 소비자·실제 화면·원어민을 계속 검수하며 비보호 shipping 사건 텍스트 결손0과 공개 데모·인간 원형·본편 HOLD를 보존한다. |
