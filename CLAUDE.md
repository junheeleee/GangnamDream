...
| **최근 완료** | **2026-07-12** — `길 위의 지갑` 정류장 벤치의 방향을 재교정했다. 카메라는 등받이 뒷면을 보고 좌석면은 전면 유리·승차구·도로 쪽으로만 뻗어 방향이 모호하지 않으며, 지갑과 하단 UI 안전 영역은 유지된다. **strict 이벤트 비주얼 부채 0** 상태(54개 잠금 / 부채 0)와 설날 CG 연기 계약 29장은 유지한다. |
...
| **마지막 업데이트** | 2026-07-12 (Codex: 정류장 벤치 좌석 방향 시각 판독 교정) |
