...
| 바로 다음 | 관계 이름14종·새 로그6종을 세 언어로 연결해 수용38,497(JA12,831·CN/TW각12,833)이다. 저장 원문·기존 로그는 그대로이며 독립 격리65와 정적8을 통과했다. 다음은 소개팅·썸·전 연인에도 연인으로 붙는 기존 유형 태그의 중립화와 남은 관계 UI30키 번역이다. 실제 화면·원어민·전체판 검수는 별도이며 공개 데모·인간 원형·본편 HOLD를 유지한다. |
