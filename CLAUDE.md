...
| **최근 진행** | **2026-07-23 (Codex)** — ORDER-43 진행 중. 고시원에 섞인 지하철 역사, 편의점의 푸드코트, 면접/학교의 공공 홀과 물체가 다른 대체음을 제거했다. 고시원 방·복도·희박한 벽 너머 생활음을 분리하고 편의점·사무실·병원·헬스장·카지노·결혼식에 해당 장소 녹음을 고정했다. 프롤로그 페이지·펜·옷 폴리를 추가하고 cue를 실제 물리 문단으로 옮겼다. 현행은 BGM 20·앰비언스 49·SFX 70, 총 139개·합성 0이며 출처 의미/Godot/장면/게임/Moral/BGM/KO·EN 렌더 계약이 통과했다. 새 clean RC와 인간 연속 청취는 OPEN이다. |
...
| **다음 작업** | **ORDER-43 새 clean RC + human listening gate.** 장소 의미 수리 커밋에서 3플랫폼 데모를 다시 발급한 뒤 프롤로그·24주·카지노·결혼식·엔딩을 헤드폰/노트북/TV로 듣고 사용자 GO를 받아야 닫는다. 자동 출처·런타임·export PASS는 장면 적합성이나 음질 승인이 아니다. |
| **마지막 업데이트** | 2026-07-23 (Codex: ORDER-43 데모 장소 의미 수리, 녹음/샘플 139개·합성 0, Godot/KO·EN 표적 QA PASS, clean RC·인간 청취 OPEN) |
