...
| 최근 완료 | 시작 화면·세이브·빌드 매니페스트의 artifact identity를 하나로 맞추고, 비호환 저장을 상태 적용 전에 차단했다. 엔진·서체·오디오 고지는 원장에서 생성해 설정과 Full/V2 package의 필수 10파일까지 검증했다. |
...
| 마지막 갱신 | 2026-08-03 (Codex: 산출물 식별·저장 호환·제3자 고지 완료) |
