...
| 바로 다음 | 전체판 JA·간체·번체 엔딩35종·사건754종·catalog834문구씩, 총19,854번역을 대조·수용했다. 판단의 비용과 작은 회신25종444문구를 더하고 기존 수용·메타9와 공개판을 보존했다. 다음 관계의 말과 책임20종 한 배치를 준비한다. 검수는 단일 큐 이어보기의 L3 OPEN, 배경 제품 53493fe 별도 보존·전체 HOLD다. |
