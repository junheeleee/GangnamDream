...
| 항목 | 내용 |
|---|---|
| **단계** | **데모 밀도 강화 + 게임 폴리시** — 생존게임 첫 6개월 + 알바 미니게임 v2 |
| **최근 완료** | **생존게임 패키지 + 알바 미니게임 v2** (2026-06-15) — 정착 지원금 1개월 단축, 불합격 아크(t≥8), 생존 이벤트 4종, 편의점 바코드 타이밍·배달 루트 퍼즐 미니게임 |
| **다음 작업** | **나머지 AP 사용처 게임성** — 구직활동·투자·자기계발 등 딸깍 수치증가인 AP 사용처에 인터랙티브 요소 추가. 또는 콜센터·중소기업 직종별 상황 카드 확충. |
| **마지막 업데이트** | 2026-06-15 |
