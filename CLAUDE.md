...
| **마지막 업데이트** | 2026-06-29 (Codex: Gangnam Meaning EN Onboarding Pass — 영어 초반 표면에 Gangnam=Seoul status symbol 의미 보강.) |
