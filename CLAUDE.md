...
| **최근 완료** | **2026-07-12** — **AP 하위 행동 일러스트 라이브러리**: 핵심 4종에 이어 자소서·면접·부업·절약·시장분석·창업·콘텐츠·이사·독서·운동·명상·투자공부 12종을 별도 오브젝트 컷으로 교체했다. 결과 축이 아니라 행동 판타지별로 함수 매핑해 같은 돈/직업 그림 반복을 막았고, 76x48 크롭과 MORAL_TINT·패드 지오메트리를 유지한다. KO/EN AP 각 24장과 모달별 아틀라스/고유 사분면 자동 단언, 57개 컴파일로 검증했다. |
...
| **마지막 업데이트** | 2026-07-12 (Codex: AP 하위 행동 12종 Gangnam Ink 일러스트 라이브러리) |
