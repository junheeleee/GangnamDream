...
| 바로 다음 | 후반 이정표·NG+22종197문구/언어를 직접 번역·독립 전량 대조·수용해 현재37,174(JA12,390·CN/TW각12,392)이다. 비보호 사건 잔여42종256문구/언어와 UI·표시 소비자는 미완료다. 이스터에그·초기 코어20종116문구/언어의 직접 번역·독립 검수를 시작한다. 공개 데모·인간 원형·본편 HOLD를 유지한다. |
