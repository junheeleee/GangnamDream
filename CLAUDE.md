...
| 바로 다음 | 현수·지연 후반부와 유물19종372문구를 더해 세 언어 총34,614번역을 수용했다(각11,538). 엔딩35종·사건1,547종·catalog834문구/locale다. 남은 비보호 사건147종1,108문구/언어와 UI·표시 소비자는 미완료 원장에서 관리한다. 다음 상철·지연 초기 연쇄19종135문구/언어는 사전 검토만 했으며 미수용이다. 기존 일본어 건강/정신 소비자 수리는 유지하고 실제 원어민·화면·본편 전체 판정은 별도다. |
...
| 그다음 | 설치 ZIP 격리 뒤 이전55ed865 원격 CI의 두 job이 끝까지 SUCCESS임을 확인했다. 현재 번역 후보의 원격 결과와 합치지 않는다. 후속 번역·UI 소비자를 계속 수리하며 Chapter 5·종막·프롤로그와 실제 관찰 의무는 큐에 보존한다. |
