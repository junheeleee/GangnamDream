...
| 바로 다음 | 첫 생활·가족·우정·진로24종591문구를 더해 세 언어 총35,610번역을 수용했다(각11,870). 엔딩35종·사건1,590종·catalog834문구/locale다. 남은 비보호 사건104종776문구/언어와 UI·표시 소비자는 미완료 원장에서 관리한다. 다음 연말 회고·고립·회복20종154문구/언어는 사전 검토만 했으며 미수용이다. 중국어 연말 동적 선택의 UI 템플릿2종 누락은 별도 수리 대상으로 확인했다. 실제 원어민·화면·본편 전체 판정은 별도다. |
