...
| **최근 완료** | **2026-07-10** — **Codex 로맨스 T0 비주얼 계약 완료**: CG 8장에 이어 바다/불꽃/벚꽃 특별 초상 6종을 추가하고 첫 키스 2종은 정확한 기존 의상을 재사용했다. manifest가 CG·히로인 의상·민준 검은 사복·시선 목표를 1:1로 잠그며 `CGRuntimeCheck`, `romance-portraits` EN 실렌더 통과. |
