...
| 바로 다음 | 공식39,292(JA13,096·CN/TW13,098)/b112/meta9. 2026-09-20 번역 지연 지적에 따라 현재 기록 수리만 마감하고 실제 중국어 UI 누락 초안을 우선한다. 비보호 shipping 사건11,578은 세 언어 수용 완료; 앞서 잔여로 센843은 비활성 참고741·보호 데모102이며 활성 본편의 번역 공백이 아니다. UI 사전3015키 합집합 기준 CN/TW각2446키가 없고 JA기존값은 별도 검수 대상이다. 초안9월23일은 연속 작업 전제의 추정이지 검수·출시 약속이 아니다. exact 단위판정은 큐가 소유하고 공개GO1·인간OPEN45·본편HOLD 유지. |
...
| 그다음 | 커피제목3 오독·KO 조사·HoldemClub consumer 등 추가 개선은 번역 초안 우선 뒤로 둔다. 시작한 기록 수리의 결함은 닫되 새 검사 확장으로 남은 저작을 미루지 않는다. 선물 안내·저장명 수리 증거는 큐를 따른다. 휴면route4 비노출·역사CI243 한정GO·Chapter5·종막·프롤로그·실제관찰·종료resource/ObjectDB 잔여를 보존하며 실제화면·원어민 미관측이다. |
...
| 마지막 갱신 | 2026-09-20 (개발·최종 내부 검수 위임 / 전체판 세 언어 번역·입력 수리 / 인간 증거 원형 보존·본편 HOLD) |
