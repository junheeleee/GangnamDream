...
| **최근 완료** | **2026-07-12** — `길 위의 지갑` 정류장 벤치를 최종 반전했다. 카메라에서 좌판과 등받이 안쪽이 함께 보이고 좌판은 화면 앞쪽으로 뻗어 방향을 즉시 판독할 수 있으며, 뒤쪽 유리 너머 도로와 지갑·하단 UI 안전 영역은 유지된다. **strict 이벤트 비주얼 부채 0** 상태(54개 잠금 / 부채 0)와 설날 CG 연기 계약 29장은 유지한다. |
...
| **마지막 업데이트** | 2026-07-12 (Codex: 정류장 벤치 앞면 방향 최종 반전) |
