...
| 바로 다음 | 엔딩 기록19단위·UI52키×3까지 수용38,311(JA12,769·CN/TW각12,771)이다. 기존JA52 검수·4정밀화와 CN/TW신규104를 구분하며 사람축을 관계만으로 좁힌 CN1도 수리했다. 남은 UI·동적 표시·실제 화면·원어민 검수를 계속하며 공개 데모·인간 원형·본편 HOLD를 보존한다. |
