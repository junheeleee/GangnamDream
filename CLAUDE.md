...
| 바로 다음 | 카지노 금융/상태18키·CN/TW36값 수용, 실제 표시 검수는 다음 별도 범위다. 이전30화면·188raw와 잔액 잘림 수리는 WORK_LOG 참조. 공식40,213/b133/meta9·보류72. 비보호 shipping 사건11,578 세 언어 수용, 잔여843은 참고741·보호102. UI3028키 중 CN/TW각2006 부재(전체 live UI 분모 아님). 남은 UI·보류 수리는 큐 참조. 공개GO1·인간OPEN45·본편HOLD 유지. |
