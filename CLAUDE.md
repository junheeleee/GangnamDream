...
| **마지막 업데이트** | 2026-06-21 (i18n 영어 번역 완성 + main 병합. 바카라/블랙잭 테이블 연출 강화, 슬롯머신 릴 심볼 코드 드로잉 고도화, 정선 카지노 허브 미니게임별 카드 아트 개선, `poker_chip_icon.png` 런타임 참조 제거. ScreenshotQA `--qa=casino` 전용 모드 추가 및 `09a/09/10a/10/11` 확인) |
