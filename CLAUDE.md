...
| 바로 다음 | 주거·직업 칭호9개18표면과 실제 소비자100그룹을 닫아 수용38,638(JA12,878·CN/TW각12,880)이다. 누적 코드 이력·일본어 보존 키·중국어 빈 fixture의 수리 뒤, 새 칭호 코드와 옛 Chapter1 스냅샷의 불일치도 별도 수리한다. 정확한 검증 상태는 실행 큐와 판정 원장이 소유하며 다음 번역은 남은 칭호·실제 UI 소비자다. 제품 내용·번역문·공개 데모·인간 원형·본편 HOLD는 보존한다. |
