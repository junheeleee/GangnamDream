...
| 바로 다음 | 중반 생활20종169문구/언어를 직접 번역·독립 전량 대조·수용해 현재36,583(JA12,193·CN/TW각12,195)이다. 비보호 사건 잔여64종453문구/언어와 UI·표시 소비자는 미완료다. 후반 이정표·NG+22종197문구/언어의 직접 번역·독립 검수를 시작한다. 공개 데모·인간 원형·본편 HOLD를 유지한다. |
