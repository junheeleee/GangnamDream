...
| 바로 다음 | 수용38,014(JA12,670·CN/TW각12,672)을 보존하고 갤러리20단위·UI27키의 세 언어 번역을 진행한다. JA기존27 검수와 CN/TW신규54를 구분하며 기존 일본어 오역2를 수리한다. 비보호 shipping 사건 텍스트 결손0, 공개 데모·인간 원형·본편 HOLD 유지. |
