...
| 바로 다음 | 사용자 지시로 ORDER-157 전체판 일본어·간체·번체 번역에 착수했다. 사건·엔딩·catalog·정적/동적 UI의 전체 분모와 증분 번역을 관리한다. 배경 수리 제품 `53493fe`의 최종 회귀·후보 등록은 별도 브랜치에서 보존한다. 사람 gate OPEN·전체 HOLD다. |
