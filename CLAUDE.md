...
| 바로 다음 | 중국어 UI220초안 검수,158수용·62기계경계HOLD. 공식39,450/b113/meta9. 비보호 shipping 사건11,578은 세 언어 수용 완료. 잔여843은 참고741·보호102다. UI 사전3015키 중 CN/TW각2367키 부재(전체 UI 분모 아님). 초안9월23일은 연속 작업 전제 추정, 검수·출시 약속이 아니다. 다음 UI 초안 우선. 분모·보류 근거는 backlog·큐 참조. 공개GO1·인간OPEN45·본편HOLD 유지. |
