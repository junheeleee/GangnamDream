...
| 바로 다음 | 전체판 일본어·간체·번체의 엔딩 3종·사건 8개를 한국어에서 독립 번역해 357문구를 원문 대조했다. source 해시 원장에서 나머지 사건·엔딩·catalog·UI를 이어간다. 배경 수리 제품 `53493fe`는 별도로 보존하며 입력 QA 잔여·사람 gate OPEN·전체 HOLD다. |
