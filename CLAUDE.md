...
| 최근 완료 | 현금의 정본 단위를 1원으로 통일하고 거래 끝에서 한 번만 정산한다. 7파일의 15사건·19기회 선택은 실제 베팅금 1원 이상일 때만 열리며, 0원 선택은 RNG·현금·스탯·플래그·로그·후속을 바꾸지 않는다. 구 소수 저장은 리퍼폰 환불 뒤 한 번 정규화되고 반복 로드는 멱등이다. W24·W48·W240 원장과 240주 수렴 모델을 새 기준으로 다시 잠갔다. |
...
| 마지막 갱신 | 2026-08-04 (Codex: 현금 1원 정산·0원 기회 차단 완료) |
