...
| **최근 진행** | **2026-07-20 (Codex)** — ORDER-37로 작성형 선택과 범용 AP의 이중 결정을 제거했다. 데모 4·10·13·16·20·23·24주의 실제 StoryMode 선택이 그 주를 소유하고, 범용 AP는 1·8주만 남는다. KO PlayStation/EN Xbox는 24주·46사건·25루트, 범용 AP 2+작성형 약속 7, Echo 4, 628/632확인으로 같은 CTA와 상태에 도달했다. EN Xbox 240주는 3,064입력·218사건·직접 주 52·Echo 20으로 `with_daeun`까지 완주했다. 전체 감사는 사건 1,565·일본어 UI 2,269키·오디오 113개·GDScript 55개 컴파일까지 통과했다. |
| **이전 주요** | **2026-07-19 (Codex)** — `goshiwon_hallway` 첫 3840×2400 마스터 승격과 활성 이미지 195개/P0 52개 해상도 장부를 완료했다. 현재 native 4K는 1개, 3배 확대 CG/배경은 137개다. 전체 이력 → `docs/WORK_LOG.md` |
| **다음 작업** | **데모 콘텐츠 다이어트 2차 + 확인 노동 압축 + 인간 재플레이** — 전경을 소유하지 못하는 단문 랜덤 사건은 결과/다리/Echo로 강등하고, 첫 주 164~166입력과 반복 확인을 줄인다. 투자·카지노의 구체 거래와 손익을 사람이 읽는 후속도 우선한다. 다음 권위 게이트는 정상 독해 데모에서 계획 기억, 실제 망설임, 결과 납득, 놓친 길의 아쉬움, 계속할 이유를 묻는 외부 플레이테스트다. 자동 증거를 재미 GO로 오인하지 않는다. |
| **마지막 업데이트** | 2026-07-20 (Codex: ORDER-37 전경 결정 소유권) |
...
- 전체 카탈로그 1,565개 중 작성형 388, 랜덤 풀 1,177. 대표 A/B 경로의 장별 전경 뿌리는 `26/25/26/16/13`, `28/24/32/23/15`다. 두 경로 모두 1~5장 고립 단편 0이고 5아키타입×3,000런은 우세 엔딩 5/5·평균 JSD 0.989다. 직접 주 52회 중 데모의 7주는 작성형 선택이 소유하고 나머지는 장면형 범용 약속이며, Echo 20개가 고른 길·실제 결과·놓친 길을 회수한다. 최신 EN Xbox 240주는 3,064입력·218사건·약속 52·Echo 20으로 완주했고 장별 입력은 `756/647/683/401/577`이다. 4장 체감 밀도와 단문 랜덤 풀은 계속 위험이며, 다음 P0는 콘텐츠 다이어트와 정상 독해 사용자 재플레이다.
