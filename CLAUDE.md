...
| 바로 다음 | 초기 코어22종420문구를 직접 번역·비저자 전량 대조해 수용37,942(JA12,646·CN/TW각12,648)다. 비보호 shipping 사건의 텍스트 결손은0이며, 전체수용 L1 오류0·표적12/고정212 회귀를 확인했고 다음 UI 묶음을 준비한다. UI·표시 소비자·원어민·실제 화면은 별도 미완료이며 공개 데모·인간 원형·본편 HOLD를 유지한다. |
