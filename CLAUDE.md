...
| 항목 | 내용 |
|---|---|
| **단계** | **데모 밀도 강화 + 게임 폴리시** — AP 전면 게임화 (알바·구직 미니게임 완성) |
| **최근 완료** | **구직 미니게임 통합** (2026-06-15) — JobHuntMiniGame.gd: 자소서(4문항 채점)/면접(5문항 타이머 압박), quality 0-3 차등 스탯 적용 |
| **다음 작업** | **남은 AP 게임화** — `_ap_study()`(자기계발) · `_ap_network()`(인맥쌓기) · `_ap_save_money()`(절약) 딸깍→인터랙티브 전환. 또는 투자 미니게임(스캘핑 외) 확충. |
| **마지막 업데이트** | 2026-06-15 |
