...
| 최근 완료 | `ORDER-71`에서 4주차 영어 유혹 선택지의 도덕 자기선언을 한국어와 같은 관찰 행동으로 교체했다. 선택 순서·게임플레이·8주차 clean/fallout 분기는 그대로이며, 이 한 문장 수리는 영어 전수 검수나 사람 GO가 아니다. |
...
| 마지막 갱신 | 2026-08-03 (Codex: ORDER-71 영어 유혹 선택지 중립화 완료) |
