...
| 바로 다음 | ORDER-101을 별도 선언해 W1~8의 온보딩·자기소개서/지원·첫 후속을 수리한다. 이후 ORDER-102의 W9~16부터 ORDER-106의 W41~48까지 8주 단위로 구현하고 ORDER-107에서 같은 48주 RC를 통합 검증한다. BUILD `.3` 동일 저장 L3와 ORDER-97/98 사람 판정은 별도로 OPEN이다. |
...
| 마지막 갱신 | 2026-08-12 (Codex: 48주 범위·공백·수리 순서 사용자 L3 승인, ORDER-101 선언 대기) |
