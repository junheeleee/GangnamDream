...
| **마지막 업데이트** | 2026-06-29 (Codex: Gangnam Ink Scene Transition Pass — MORAL_TINT 연동 전역 전환 레이어와 transition 캡처 QA 추가.) |
