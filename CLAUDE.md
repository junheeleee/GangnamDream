...
| 바로 다음 | 상철·지연 초기 인연·투자·카지노19종405문구를 더해 세 언어 총35,019번역을 수용했다(각11,673). 엔딩35종·사건1,566종·catalog834문구/locale다. 남은 비보호 사건128종973문구/언어와 UI·표시 소비자는 미완료 원장에서 관리한다. 다음 초기 생활·인연24종197문구/언어는 사전 검토만 했으며 미수용이다. 기존 일본어 건강/정신 소비자 수리는 유지하고 실제 원어민·화면·본편 전체 판정은 별도다. |
