...
| 바로 다음 | 첫 안내5언어 화면 확인 뒤 중국어 생활/UI 보완·경마설명8값 복구. 공식39,929/b123/meta9. 착순 오탐6 수리·보류72 유지. 비보호 shipping 사건11,578 세 언어 수용, 잔여843은 참고741·보호102. UI 사전3016키 중 CN/TW각2129키 부재(전체 UI 분모 아님). 초안9월23일은 연속 작업 전제 추정, 검수·출시 약속 아님. 화면·남은 UI·보류 수리는 큐 참조. 공개GO1·인간OPEN45·본편HOLD 유지. |
