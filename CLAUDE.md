...
| **최근 진행** | **2026-07-24 (Codex)** — USER-P0G 완료. StoryMode 장면 설정에 영속적인 `느리게 / 보통 / 빠르게` 출력 속도를 추가했다. 기존 보통 체감, 빠르게 2배, 느리게 1.65배 간격과 상대적 `pace=slow`, AUTO 실제 타이핑시간 보정, 960×600 패드 포커스 및 한영 현장 전환을 런타임으로 잠갔다. |
...
| **마지막 업데이트** | 2026-07-24 (Codex: StoryMode 출력 속도 3단계·영속·AUTO 보정·960×600 패드 계약 완료, 사용자 재플레이/청취 OPEN) |
