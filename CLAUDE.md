...
| **최근 진행** | **2026-07-16 (Codex)** — ORDER-16 입력×해상도 매트릭스를 완료했다. 3창모드·6해상도, 키보드/마우스·3패드 글리프, 9개 미니게임 키보드 핵심 과업, 24주 키보드/마우스 데모 완주, 1080p/QHD/4K/21:9 실렌더를 출시 계약으로 잠갔다. 물리 패드 게이트 전 Full Controller Support 표기는 보류한다. |
...
| **다음 작업** | **ORDER-18 기술 부채 전수 인벤토리 `[ ]`** — 출시 전 저위험 수리(A), 출시 후 엔진 경화(B), 의도된 정본(C)을 분리해 데모 안정성을 해치지 않는 범위만 집행한다. |
| **마지막 업데이트** | 2026-07-16 (Codex: ORDER-16 완료) |
