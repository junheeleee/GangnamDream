...
| 바로 다음 | ORDER-125가 폐기한 BUILD `.4` 대신 `2026.08.24.5` clean `full_rc`를 세 플랫폼·KO/EN 240주·전체 감사와 함께 재발급한다. ORDER-124 `.3`의 L3 GO 전 story-first 이관이나 AP 엔진 삭제는 하지 않는다. |
...
| 마지막 갱신 | 2026-08-24 (Codex: ORDER-125 BUILD `.4` stale causal snapshot 3건 확인·폐기, `.5` 감사 계약 수리와 clean full_rc 재발급 착수, ORDER-124 사용자 플레이 병행) |
