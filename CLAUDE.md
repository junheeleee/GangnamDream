...
| 바로 다음 | 전체판 JA·간체·번체 엔딩35종·사건1,089종·catalog834문구씩, 총25,818번역을 대조·수용했다. 현수·가족·건강·목표41종738문구를 더하고 기존 수용·메타9와 공개판을 보존했다. 다음 직장·투자·이별40종 두 배치를 준비한다. 검수는 단일 큐 이어보기의 L3 OPEN, 배경 제품 53493fe 별도 보존·전체 HOLD다. |
