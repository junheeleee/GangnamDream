...
| 바로 다음 | 공식39,211(JA13,069·CN/TW13,071)/b110/meta9. 이야기 진행표20키의60을 수용해 중국어40누락·JA3오역을 고쳤다. 커피 회차 검사 오탐은 별도 수리했고 첫 실패를 보존한다. 선택 외 UI·기존39,151 보존과 유한 회귀·단위판정은 큐의 exact 증거가 소유한다. 실제화면·원어민 미관측, 공개GO1·인간OPEN45·본편HOLD 유지. |
