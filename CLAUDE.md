...
| 바로 다음 | 연말 회고·고립·회복20종462문구를 더해 세 언어 총36,072번역을 수용했다(각12,024). 엔딩35종·사건1,610종·catalog834문구/locale다. 전량 기초 검사 오류0·지정 회귀12 통과 후 정확 제품의 독립 내부 판정을 결속한다. 남은 비보호 사건84종622문구/언어와 UI·표시 소비자는 미완료다. 다음은 중국어 연말 동적 선택의 누락 템플릿2종/4값을 별도 선언으로 수리한다. 실제 원어민·화면·본편 전체 판정은 별도다. |
