...
| 최근 완료 | ORDER-123에서 W9의 합법적인 3~4개 약속 후보를 자르지 않고 Board·MainGame·입력 계보를 복구했다. candidate/bundle/route/variant를 분리했고 KO/EN × keyboard/gamepad 24주 4개와 KO/EN × 960/1280 화면 4개, 독립 L2가 통과했다. |
| 바로 다음 | ORDER-123 최종 CI green 뒤 ORDER-119 마감을 재개한다. 사용자 최종 GO는 계속 OPEN이며, 다른 서사·밸런스·R1b 범위를 넓히지 않는다. |
...
| 마지막 갱신 | 2026-08-22 (Codex: ORDER-123 W9 다중 약속 선택·KO/EN 24주 복구 완료) |
