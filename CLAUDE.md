...
| 항목 | 내용 |
|---|---|
| **단계** | **스팀 출시 준비** — 아크 깊이 작업 진행 중 |
| **최근 완료** | **아크 1~4순위 전체 완료**: 아버지(5단계)·재혁(3개 추가)·다은(3개 추가)·한지연(2개 추가). 아크 패널 버그 3종(daeun/jiyeon/sangchul) 수정. audit ERROR 0. |
| **다음 작업** | QA 플레이스루 (로컬 Godot 필요) — 전체 아크 흐름·선택 연결·엔딩 확인 |
| **마지막 업데이트** | 2026-06-10 (아크 깊이 작업 1~3차 완료) |
