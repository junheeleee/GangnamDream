...
| 바로 다음 | 주거·직업 칭호9개의18표면을 세 언어로 연결하고51을 추가 수용해38,638(JA12,878·CN/TW각12,880)이다. 실제 도감·해금 알림·엔딩 카드 등100그룹을 통과했고 조건·저장·기존41칭호는 그대로다. 나머지 칭호와 UI의 영어 직행을 계속 수리한다. 실제 렌더·원어민·전체판 검수는 별도이며 공개 데모·인간 원형·본편 HOLD를 유지한다. |
