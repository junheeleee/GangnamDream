...
| 바로 다음 | 주거·직업 칭호9개18표면과 실제 소비자100그룹을 닫아 수용38,638(JA12,878·CN/TW각12,880)이다. 이전 c2cc7fd 원격 CI의 실패5곳·원인3개를 먼저 표적 수리한 뒤 남은 칭호와 UI 번역을 계속한다. 제품·번역문·공개 데모·인간 원형·본편 HOLD는 보존한다. |
