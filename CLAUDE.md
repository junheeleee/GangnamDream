...
| **최근 완료** | **2026-07-12** — **MORAL_TINT 지각·얼굴·결과 주의 순서 연결**: 5개 정점의 본문/선택지 지각, 같은 고시원에서 변하는 민준의 얼굴에 이어 동일 선택 결과의 도착 순서까지 밴드별로 분리했다. Black은 돈·성과를 먼저 보고 사람의 대가를 뒤늦게, White는 사람·몸·마음을 먼저 보고 경제적 대가를 뒤늦게 인식하며 Gray는 균형을 유지한다. 반대 대가는 삭제하지 않고 4칸 초과 시에도 최소 한 칸을 보존한다. 관계 증감도 손익 판정에 포함했고 외부 샘플 없는 장부 접점/천·호흡 주의음 2종을 추가했다. 수치·밴드 라벨은 계속 숨기며 KR/EN 동일 선택 결과판과 자동 순서·보존 검사를 추가했다. |
...
| **마지막 업데이트** | 2026-07-12 (Codex: 모랄 결과의 돈↔사람 주의 순서·비징글 오디오 연결) |
