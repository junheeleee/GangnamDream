...
| 바로 다음 | 첫 안내 세 언어·5언어 화면 확인 뒤 중국어 직업/신혼집/기록10값 수용. 공식39,905/b120/meta9. 경마20 복구 뒤 보류90 유지. 비보호 shipping 사건11,578 세 언어 수용, 잔여843은 참고741·보호102. UI 사전3016키 중 CN/TW각2141키 부재(전체 UI 분모 아님). 초안9월23일은 연속 작업 전제 추정, 검수·출시 약속 아님. 화면·남은 UI·보류 수리는 큐 참조. 공개GO1·인간OPEN45·본편HOLD 유지. |
