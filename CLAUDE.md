...
| **마지막 업데이트** | 2026-06-22 (English Surface + AP Modal Polish: AP 세부 모달 카드화, 영어 메인 HUD/돈·관계 모달/정보 패널 ScreenshotQA 추가, 영어 로고/탑바/날짜/금액/주거명/인물명/로그/관계 단계 라벨 정리. 전체 ScreenshotQA 및 audit.sh 통과.) |
