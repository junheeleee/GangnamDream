...
| 항목 | 내용 |
|---|---|
| **단계** | **영문 번역 100% 완료 + 비주얼 에셋 병합 — 스토어 소재/비주얼 QA 대기** |
| **최근 완료** | **2026-06-19** — (1) 영문 번역 전량 완료: life_events(111), relationship_events(53) 포함 978/970 이벤트. (2) main 병합: Codex 비주얼 에셋(정선 카지노 내부/입구/외관, 헬스장, 한강, 남산, 카드/칩) + 배경 라우팅 재적용 |
