...
| 항목 | 내용 |
|---|---|
| **단계** | **스팀 출시 준비** — 인게임 폴리시 3종 완료, 에셋 QA 단계 |
| **최근 완료** | **인게임 폴리시 3종**: 중간 저장/불러오기(시스템 메뉴 슬롯 1–3), 직업 승진 현황 UI(근속 바+성과 게이트+다음 직급 예시), 목표 달성 속도(_months_to_goal_estimate). **이전**: Steam Deck 대응, DisplayManager, 빌드 파이프라인 |
...
| **마지막 업데이트** | 2026-06-10 (인게임 폴리시 3종 완료) |
