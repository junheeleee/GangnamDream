...
| 최근 완료 | ORDER-154 제품 `18006c9`에서 결혼 첫날 네 장면과 M56 비교본 보관 장면의 혼합 대화 이름표를 숨겼다. 실제 StoryMode KO/EN 24경우·262문단, 정적 self-test 71건, Chapter 1 장기 self-test 502건과 영향 선택 43개를 통과했고 독립 코드리뷰 blocker 0이다. 원고·선택·효과·배경·초상·CG·오디오는 불변이며 사람 GO가 아니다. |
| 바로 다음 | ORDER-155 착수 중이다. Chapter 5 저작 event 7개의 장소·시간대를 실제 선택 결과와 맞춘다. 낮 진료실·역 계단/역무실·낮 한정식집·콘서트 홀·빌라 보수 현장 6자산을 만들고, 오픈하우스는 기존 강남 아파트를 명시한다. 생활 routine 6개는 다음 settled-frame 묶음이며 두 배치와 새 exact 후보 전에는 플레이를 요청하지 않는다. 사람 gate OPEN·전체 HOLD다. |
...
| 마지막 갱신 | 2026-09-05 (ORDER-154 이름표 완료 / ORDER-155 저작 장면 배경 착수 / 사람 gate OPEN·본편 HOLD) |
