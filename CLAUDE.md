...
| 항목 | 내용 |
|---|---|
| **단계** | **영문 번역 100% 완료 — 스토어 소재 대기** |
| **최근 완료** | **2026-06-19** — 영문 번역 전량 완료. life_events(111), relationship_events(53) 포함 978/970 이벤트 번역. 브랜치 `claude/game-polish-steam-uh6ldg` 푸시 완료 |
