...
| 바로 다음 | 카지노 CN/TW30화면·188합성raw 검수와 룰렛 잔액 잘림 수리는 WORK_LOG 참조. 다음은 금융/상태 부모18키 번역 후보. 공식40,177/b132/meta9·보류72 유지. 비보호 shipping 사건11,578 세 언어 수용, 잔여843은 참고741·보호102. UI3028키 중 CN/TW각2024 부재(전체 live UI 분모 아님). 남은 UI·보류 수리는 큐 참조. 공개GO1·인간OPEN45·본편HOLD 유지. |
