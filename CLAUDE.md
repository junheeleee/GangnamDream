...
| 항목 | 내용 |
|---|---|
| **단계** | **스팀 출시 준비** — 영어 번역 완전 완료 |
| **최근 완료** | **영어 이벤트 번역 전체 완료** — 17개 EN 오버레이 파일, 150개 이벤트 번역 완료 (story/life/drama/relationship/hidden/arc × 4/scenario_cafe × 2/amb_scenarios × 6/investment) |
| **다음 작업** | **QA 플레이스루** (로컬 Godot 필요) — EN 모드 클릭 흐름·번역 자연스러움 검증. 또는 **콘텐츠 추가**: 현재 ~450개 → 500개 목표 |
| **마지막 업데이트** | 2026-06-11 (영어 번역 완전 완료) |
