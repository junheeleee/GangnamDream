...
| 바로 다음 | 전체판 일본어·간체·번체에서 엔딩35종·사건503개·catalog834문구씩, 총14,889번역을 원문 대조·수용했다. 비표시 메타9와 기존 번역을 보존하며 창업·정치·정선25장면을 더했다. 다은 일본어 존대 복구도 유지했다. 남은 생활 사건·UI·소비자를 이어간다. 검수 대기는 단일 큐의 이어보기로 유지한다. 배경 제품 `53493fe`는 별도 보존, 입력 QA 잔여·사람 gate OPEN·전체 HOLD다. |
