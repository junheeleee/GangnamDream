...
| **최근 완료** | **강원랜드 카지노 5종 + 프리미엄 연출 1차** — 슬롯·룰렛·빅휠·블랙잭·바카라 허브 통합 위에 블랙잭/바카라 배너·플래시·흔들림, ScalpingGame 손익 배너, TradingFloor 평균단가선/체결 플래시 추가 (2026-06-15) |
| **다음 작업** | **2만원급 품질 패스** — 강원랜드 5게임 실기 QA 후 카드/칩/휠/릴 애니메이션, 딜러 콜, 전용 SFX, 테이블 레이아웃 고도화. 이후 전체 QA 플레이스루 |
| **마지막 업데이트** | 2026-06-15 (`origin/main` 0b57186 rebase 반영 완료, `./tools/audit.sh` ERROR 0 / WARNING 0 통과) |
