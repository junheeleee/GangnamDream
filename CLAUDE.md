...
| 바로 다음 | 수용38,311(JA12,769·CN/TW각12,771)을 보존하고 엔딩 통계·재시작23단위·UI42키를 세 언어로 직접 대조·번역한다. 기존JA42와 CN/TW신규84를 구분하며 엔딩·기록·동적 소비자와 공개 언어는 바꾸지 않는다. 남은 UI·화면·원어민 검수와 본편HOLD·인간/공개 원형을 보존한다. |
