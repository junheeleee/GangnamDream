...
| 항목 | 내용 |
|---|---|
| **단계** | **스팀 출시 준비** — 아크-게임플레이 연결 완료 (에필로그·패시브·정보 이벤트) |
| **최근 완료** | **아크-게임플레이 연결**: 엔딩 인연 에필로그(5인 stage별), 인연 월간 패시브(아버지 정신+1/연인 스트레스-2/상철 투자감각), 상철 투자 정보 이벤트 2종 / **AP vignette 완성**: 저축·인맥·공부 4종 풀 61장면 / **아크 텍스트 확장**: 핵심 8종 |
| **다음 작업** | **이미지·오디오 보강** (tools/generate_assets.py + gpt-image-2 사용, Codex 토큰 필요): 1) 미완성 이미지 에셋 파악 2) 신규 BGM/SFX 필요 항목 파악 3) 생성 후 Godot Reimport |
| **마지막 업데이트** | 2026-06-11 (아크-게임플레이 연결) |
