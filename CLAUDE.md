...
| **최근 진행** | **2026-07-17 (Codex)** — P1-E-9 `burnout` 전용 결산 CG를 연결했다. 응급 관찰 침상 1인칭 시점의 형광등·연결된 링거·한 손·닿지 않은 폰으로 신체가 먼저 멈춘 순간을 고정하고 `mental_break`와 분리했다. KO/EN `ending-p1` 각 19컷과 전체 감사를 통과해 P1 결산 CG 9/9를 완료했다. |
...
| **마지막 업데이트** | 2026-07-17 (Codex: `burnout` 결산 CG·한영 19컷 검수 완료, P1-E 9/9·사용자 Demo Round 2 대기) |
