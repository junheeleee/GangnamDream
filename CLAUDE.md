...
| 바로 다음 | 고지 JA/CN/TW 안내42표기 검증 완료. 블랙잭 분할 더블 원금 수리; 중국어 표시/입력·정산의 한정 검수 근거는 WORK_LOG 참조. 공식40,129/b130/meta9·보류72 유지. 비보호 shipping 사건11,578 세 언어 수용, 잔여843은 참고741·보호102. UI 사전3028키 중 CN/TW각2048키 부재(전체 live UI 분모 아님). 남은 UI·보류 수리는 큐 참조하며 번역 전체 완료일은 확정하지 않는다. 공개GO1·인간OPEN45·본편HOLD 유지. |
