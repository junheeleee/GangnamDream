...
| 그다음 | 실행 표의 다음은 ORDER-73이다. P-3 24주 T1 정점은 ORDER-75로 남고, 실제 데모 저장→정식판 25주 이월·치명 비용 표면·화폐 단위·125년 동기 문제는 `PROPOSALS.md` P-4~P-7에서 사용자 결정을 기다린다. 실제 순서는 `CODEX_QUEUE.md`만 소유한다. |
