...
| **최근 진행** | **2026-07-19 (Codex)** — PC 디스플레이 자동 레이아웃 게이트를 8해상도×2언어로 확장했다. 960×600~4K·21:9의 설정·AP·Story 선택과 세 패드 글리프 총 54PNG가 픽셀 크기·TV 안전영역·포커스·cover 무왜곡을 통과했다. 1280×800 래스터 원본의 4K 확대와 물리 Deck/TV는 별도 미완 게이트로 보존한다. |
...
| **마지막 업데이트** | 2026-07-19 (Codex: PC·Deck·TV 디스플레이 자동 레이아웃 게이트) |
