...
| 바로 다음 | 미착수 자동 큐는 없다. 정상 속도 전체 플레이·장별 연속 청취·물리 패드·외부 10인 독해/재미·데모 GO 뒤 일본어 본문/원어민 검수를 사람 게이트로 실행한다. |
| 열려 있는 사람 게이트 | 정상 속도 전체 플레이, 장별 헤드폰·노트북·TV 연속 청취, 물리 Steam Deck/DualSense/Switch Pro, 외부 정상 독해·재미 GO가 미완료다. |
| 마지막 갱신 | 2026-07-26 (Codex: 활성 큐 자동 범위 전수 재감사·clean RC PASS) |
