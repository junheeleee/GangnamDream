...
| 바로 다음 | M49~M60의 최종 제안·보증 거울·세 사람의 방·명의·실행·마지막 서명·사람들의 이후를 ‘빈칸 수’가 아니라 각 달에 실제로 벌어지는 사건에서 출발해 쓴다. 기존 강한 M60 서명과 ORDER-104 기준 원고는 보존하고, 배우·문서·접수 상태가 다른 경로는 공용 가정문으로 합치지 않는다. |
