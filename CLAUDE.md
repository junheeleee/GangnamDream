...
| **마지막 업데이트** | 2026-06-29 (Codex: Demo AP Focus Surface Pass — 첫 반복 AP 행동 화면의 Steam Deck/영어 가독성·조작감 보강.) |
