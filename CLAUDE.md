...
| 바로 다음 | 공식 수용은38,878(JA12,958·CN/TW각12,960) 그대로다. 설명 수리254는 source d722204·검토abf8e0d의 독립 내부GO로 닫았다. 남은11칭호/22면의 세 언어66은 직접 번역·독립 검토 뒤 승인했고, 새 lookup22/source 전단을 적용 중이다. 첫baseline26은 capture완료·새API부재·유효변조0이다. 첫post·실제 소비자·공식수용 뒤 bonus/top으로 이어간다. 공개GO1·인간OPEN45·본편HOLD는 별도다. |
