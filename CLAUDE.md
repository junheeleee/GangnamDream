...
| 바로 다음 | Chapter 5 생활 routine 6개의 실제 settled frame을 먼저 재현해 공원·집밥·SAVE/REST 장소가 현재 주거·행동과 맞는지 별도 묶음으로 닫는다. 이 묶음까지 끝난 새 exact 후보 전에는 두 경로 플레이를 요청하지 않는다. 사람 gate OPEN·전체 HOLD다. |
...
| 마지막 갱신 | 2026-09-05 (Ch5 저작 장소 7개 완료 / 생활 routine settled-frame 다음 / 사람 gate OPEN·본편 HOLD) |
