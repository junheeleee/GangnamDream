...
| 항목 | 내용 |
|---|---|
| **단계** | **데모 밀도 강화 + 게임 폴리시** — 30억 경로 명확화 + 아크 흐름 정비 완료 |
| **최근 완료** | **30억 경로·아크 정비** (2026-06-15) — arc_invest_guidance 이벤트·아크 타이밍 힌트·골 바 마일스톤·sangchul_03 조건 완화 |
| **다음 작업** | **QA 플레이스루** — 실제 Godot 실행 후 미니게임 흐름 검증. 또는 투자 미니게임(스캘핑 외) 확충 (선물·부동산·코인). |
| **마지막 업데이트** | 2026-06-15 |
