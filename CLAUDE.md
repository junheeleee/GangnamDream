...
| 바로 다음 | 월초 돌발상황·시장부모15키씩30초안 전수검수·수용, 신규보류0. 기보류110 보존. 공식39,872/b117/meta9. 비보호 shipping 사건11,578 세 언어 수용 완료, 잔여843은 참고741·보호102. UI 사전3015키 중 CN/TW각2156키 부재(전체 UI 분모 아님). 초안9월23일은 연속 작업 전제 추정, 검수·출시 약속 아님. 첫고지본문·보류검사·남은 UI는 큐 참조. 공개GO1·인간OPEN45·본편HOLD 유지. |
