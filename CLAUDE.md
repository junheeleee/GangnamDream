...
| 바로 다음 | 생활 선택·부채·직장24종507문구를 더해 세 언어 총32,991번역을 수용했다(각10,997). 엔딩35종·사건1,468종·catalog834문구/locale이며 남은 사건226종과 UI·표시 소비자는 미완료 원장에서 관리한다. 자각 모달 KO/EN controlled W17 입력 수리와 위임 검수 운영의 최종 차선을 마감한다. 다음 번역은 선택을 회수하는 callback/shadow18종 권고이며 아직 미수용이다. |
