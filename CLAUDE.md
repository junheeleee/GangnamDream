...
| 항목 | 내용 |
|---|---|
| **단계** | **스팀 출시 준비** — Steam Deck Verified 컨트롤러 지원 완료 |
| **최근 완료** | **Steam Deck 컨트롤러 지원**: StoryMode A버튼 텍스트 진행·선택지 D패드 탐색, 메인게임 LB/RB 탭 순환, 마우스 커서 자동 숨김, 포커스 비주얼, 패드 힌트 수정 |
| **다음 작업** | QA 플레이스루 (로컬 Godot 필요) — 세이브/로드 이벤트 중복, 30억 도달 실측, 마진콜 타이밍, 퇴직 달 정산; Linux 빌드 확인 (Steam Deck System Support) |
| **마지막 업데이트** | 2026-06-10 (Steam Deck 컨트롤러 지원) |
