...
| 바로 다음 | 중국어 UI202초안 검수,164수용·38기계경계HOLD. 이전보류62 보존. 공식39,614/b114/meta9. 비보호 shipping 사건11,578 세 언어 수용 완료, 잔여843은 참고741·보호102. UI 사전3015키 중 CN/TW각2285키 부재(전체 UI 분모 아님). 초안9월23일은 연속 작업 전제 추정, 검수·출시 약속 아님. 다음 UI 초안 우선. 분모·보류는 backlog·큐 참조. 공개GO1·인간OPEN45·본편HOLD 유지. |
