...
| **다음 작업** | **ORDER-16 입력×해상도 매트릭스 `[~]`** — Living Scene과 데모 AP를 포함해 1080p/QHD/4K/21:9, 키보드·마우스·Xbox·DualSense·Switch Pro의 실제 표면과 Reduce Motion 옵션을 출시 계약으로 잠그는 중이다. |
| **마지막 업데이트** | 2026-07-16 (Codex: ORDER-16 파일 범위 선언) |
