...
| **다음 작업** | **① relationship drift 이벤트 KR+EN 감사 (5개 추가 완료, EN 커버리지 재확인). ② confrontation/reckoning 이후 — 상철과 거리를 둔 후 또는 묻은 후의 장기 여파 씬 (t70~90). ③ Godot 실제 빌드 후 description_if_known 렌더링 확인. ④ Steam App ID 등록 후 STEAM_APP_ID 교체.** |
| **마지막 업데이트** | 2026-06-23 (Claude: 상철 이후 중간 씬 2종 — 알면서도 이용하는 구간 t38~59 + 페이오프 배선) |
