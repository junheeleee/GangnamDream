...
| 항목 | 내용 |
|---|---|
| **단계** | **스팀 출시 준비** — 캐릭터 아크 완성, 온보딩 강화 완료 |
| **최근 완료** | **캐릭터 아크 완성**: 한지연(5단계)/임상철(5단계)/아버지(4단계) arc 이벤트 신규 작성, cast_effects 체인 연결 — 153+42 이벤트 / **온보딩 강화**: 정석/비정석 루트 설명 튜토리얼 + 투자 첫방문 가이드 |
...
| **마지막 업데이트** | 2026-06-11 (캐릭터 아크 + 온보딩 강화) |
