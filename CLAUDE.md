...
| 바로 다음 | 공식39,292(JA13,096·CN/TW13,098)/b112/meta9. 2026-09-20 사용자의 번역 지연 지적에 따라 현재 기록 수리만 마감한 뒤 남은 번역 초안을 우선한다. 마지막 수용 기준 사건11,578/12,421(언어별843 남음), UI 포함 약75%이며 초안 완료 목표9월23일은 연속 작업 전제의 추정이지 검수·출시 약속이 아니다. exact 단위판정은 큐가 소유하고 공개GO1·인간OPEN45·본편HOLD 유지. |
