...
| **최근 완료** | **주 단위 턴 시스템 전환** (2026-06-15) — 1턴=1주/4턴=1달/AP 2개/턴/데모 24턴(6개월). AP 비녜트 6종 추가(자소서·면접·구직·알바·창업·콘텐츠). IS_DEMO 프레임 구현. |
| **다음 작업** | **이벤트 flag 체인 6턴→24턴 튜닝** — follow_up 쿨다운 조정으로 6개월 안에 선택이 메아리치게. 이후 스탯 게이트 설계. |
| **마지막 업데이트** | 2026-06-15 |
