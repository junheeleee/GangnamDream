...
| 바로 다음 | 엔딩 통계·재시작23단위·UI42키×3까지 수용38,437(JA12,811·CN/TW각12,813)이다. 기존JA42 검수·5정밀화와 CN/TW신규84를 구분한다. 남은 UI·동적 표시·소비자 수리·실제 화면 검수를 계속하며 공개 데모·인간 원형·본편 HOLD를 보존한다. |
