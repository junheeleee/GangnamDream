...
| 바로 다음 | 수용38,095(JA12,697·CN/TW각12,699)을 보존하고 설정11단위·UI20키를 세 언어로 직접 대조·번역한다. JA기존20과 CN/TW신규40을 구분하며 실제 설정값·공개 언어 선택은 바꾸지 않는다. 남은 UI·표시 소비자·실제 화면·원어민 검수, 공개 데모·인간 원형·본편 HOLD 유지. |
