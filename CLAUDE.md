...
| 항목 | 내용 |
|---|---|
| **단계** | **스팀 출시 준비** — 90점 라이팅 패스 완료, 이미지·오디오 보강 필요 |
| **최근 완료** | **90점 라이팅 패스**: 시그니처 이벤트 `father_wedding_call` (아버지의 전화, "최적의 선택이었다."), 챕터 브레이크 3종(15/30/45턴), 이벤트 11종 리라이트 — 138→142 이벤트 |
...
| **마지막 업데이트** | 2026-06-11 (90점 라이팅 패스) |
