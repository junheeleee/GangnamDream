...
| 바로 다음 | 새 active `chapter5_finale_rc`에서 property와 `general_near_goal_father_passed`를 KO 정상 속도로 M49→M60→후일담→크레딧 6/6까지 다시 플레이한다. 지갑 초대에서 수락과 서로 확인한 날짜·장소가 식당 도착보다 먼저 보이고, 거절하면 도착하지 않는지 확인한다. |
...
| 마지막 갱신 | 2026-09-02 (ORDER-150 지갑 동의 수리 후보 발급 / 두 경로 재플레이 OPEN / 본편 M01~M60 HOLD) |
