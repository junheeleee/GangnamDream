...
| **최근 진행** | **2026-07-15 (Codex)** — `ORDER-24` 다은 결혼식을 `먼저 선 사람→다은의 속도→신랑석` 3링크·2선택점으로 확장했다. 민준이 먼저 단상에서 기다리고 다은이 나중에 입장하는 순서, 화면 왼쪽 빈 신랑석/오른쪽 찬 신부석, 소형/풀 변주와 기존 최종 효과를 정본·CG·감사에 함께 고정했다. 정점 래칫은 PASS 4/부채 24. |
...
| **마지막 업데이트** | 2026-07-15 (Codex: ORDER-24 다은 결혼식 3링크·CG 정합 수리 완료, PASS 4/부채 24, KO/EN 27컷 검증) |
