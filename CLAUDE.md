...
| **다음 작업** | ①✅리캡 데이터 측 완료(연락 원장+엔딩 '시간의 기록') — 비주얼 카드는 Codex ②**리캡 카드 잔인한 통계**(human_weeks_total·cast 데이터 기반, 비주얼은 Codex) ④몽타주 실플레이 밸런스 체감 QA ⑤✅`docs/SCENE_DIRECTION.md` 완료(스키마+정점 16장면 연출 대본) — Codex 구현 대기(CODEX_QUEUE 5.5) |
