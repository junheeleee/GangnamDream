...
| **최근 완료** | **강원랜드 바카라·블랙잭 구현 + 홀덤 업그레이드** (2026-06-14) — 바카라: 6덱 슈·카드순차공개·로드맵·커미션. 블랙잭: 더블·스플릿·기본전략힌트. 홀덤: 팟오즈·핸드히스토리·1/3팟레이즈 추가. 이벤트 이머전 픽스: life/drama/relationship (2026-06-13) |
| **다음 작업** | **투자 미니게임 개선** — ScalpingGame 차트 폴리시 + TradingFloor 시각화 강화. 이후 경마장 세션 통계 패널. 완료 후 → QA 플레이스루 |
| **마지막 업데이트** | 2026-06-14 (바카라·블랙잭 신규 구현, 홀덤 업그레이드) |
