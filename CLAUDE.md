...
| 최근 완료 | `ORDER-51`: 도달 가능한 콜백 24건 중 결함 3건을 한영으로 수리하고, 콜백 620건·체인 12건의 실제 도달성을 계산해 휴면 기준선 596+12의 증가를 막는 회귀 게이트를 추가했다. |
| 바로 다음 | `ORDER-52`: 유저가 선택한 지연 회수 32건의 산문 25건과 T1 예약 34행을 수리·배선한다. T2 슬롯 점유 3행은 엔진 배열 확장 승인 전까지 건드리지 않는다. 그 외 정상 속도 전체 플레이·장별 연속 청취·물리 패드·외부 10인 독해/재미·데모 GO 뒤 일본어 검수는 사람 게이트다. |
| 열려 있는 사람 게이트 | 정상 속도 전체 플레이, 장별 헤드폰·노트북·TV 연속 청취, 물리 Steam Deck/DualSense/Switch Pro, 외부 정상 독해·재미 GO가 미완료다. |
| 마지막 갱신 | 2026-07-26 (Codex: ORDER-51 도달 콜백 수리·회귀 게이트 완료) |
