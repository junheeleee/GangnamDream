...
|---|---|
| **단계** | Phase 3 진행 중 |
| **최근 완료** | 콘텐츠 패스 2 — 25-35세 구간 이벤트 14개 추가 (번아웃, 커리어 천장, 결혼 압박, 단타 대가, 3배 수익, 정석 배당 마일스톤 등). 드라마 이벤트 버그 수정. 총 381개 이벤트. |
| **다음 작업** | **Phase 3-D QA** — 저장/불러오기 검증, 엔딩 도달 경로 확인, 치명적 버그 스캔 |
| **마지막 업데이트** | 2026-05-28 |
...
| 시작 자금 | 1,000,000원 |
| 시작 나이 | 20세 |
| 기본 고정 지출 | 800,000원/월 (고시원) / 110만 (원룸) / 160만 (아파트) / 280만 (강남) |
| 건강/정신력 초기값 | 70 |
| 스트레스 초기값 | 25 |
| 월별 압박 (기본) | 건강 -2, 정신 -3, 스트레스 +3/월 |
| 강남드림 조건 | 총자산 20억 이상 |
| 파산 조건 | 현금 -3,000만 이하 |
| 은퇴 조건 | 나이 65세 |
