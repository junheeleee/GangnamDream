...
| 항목 | 내용 |
|---|---|
| **단계** | **미니게임 퀄리티 강화** — 독립 판매 가능 수준 완성도 (Week 2) |
| **최근 완료** | **튜토리얼 시스템 + 연출 2차 패스** — 전 게임 ❓ 도움말 버튼·허브 규칙 카드, 메인게임 3슬라이드 온보딩, 슬롯 잭팟/니어미스/빅윈 3단계, 룰렛 result 펄스, 블랙잭 딜 팝 애니, 경마 3-2-1 카운트다운, 메인게임 위험 스탯 펄스 경보, AudioManager.play_sfx 버그 수정 (2026-06-14) |
| **다음 작업** | **QA 플레이스루** — 실 Godot에서 전체 게임 흐름·클릭 흐름·오류 검증. 이후 코덱스 이미지 에셋 폴리싱 |
| **마지막 업데이트** | 2026-06-14 (`./tools/audit.py` ERROR 0 / WARNING 0 전 커밋 통과) |
