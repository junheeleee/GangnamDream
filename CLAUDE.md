...
| 바로 다음 | M56~M60 아버지 흔적→문서→명의→사람 판정→무이체→마지막 서명→먼저 보내는 말을 9루트·24선택으로 잇는 중이다. 조건 없는 거래는 `no_executable_contract`로 남긴다. 장면 길이는 인과·감정 기능으로 정한다. |
...
| 마지막 갱신 | 2026-08-26 (Codex: 5장 M56~M60 문서·사람·엔딩 연결 착수) |
