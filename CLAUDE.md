...
| 바로 다음 | 중국어 결산·경고90초안 전수검수, 용어·구두점2수리 후90수용. 기보류110 보존. 공식39,842/b116/meta9. 비보호 shipping 사건11,578 세 언어 수용 완료, 잔여843은 참고741·보호102. UI 사전3015키 중 CN/TW각2171키 부재(전체 UI 분모 아님). 초안9월23일은 연속 작업 전제 추정, 검수·출시 약속 아님. 다음 첫고지본문·남은 UI 우선. 분모·보류는 backlog·큐 참조. 공개GO1·인간OPEN45·본편HOLD 유지. |
