...
| 바로 다음 | 수용37,942(JA12,646·CN/TW각12,648)과 비보호 shipping 사건 텍스트 결손0을 보존하고, 기록 불러오기 UI24키를 세 언어로 직접 대조·번역한다. JA기존24와 CN/TW신규48을 구분하며 UI·표시 소비자·실제 화면·원어민은 미완료다. 공개 데모·인간 원형·본편 HOLD 유지. |
