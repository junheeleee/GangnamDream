...
| 바로 다음 | 수용37,522(JA12,506·CN/TW각12,508)을 보존하고 남은 비보호 사건22종140문구/언어를 병렬 직접 번역·독립 전량 검수한다. 초기 source 봉인 뒤 저작하며 UI·표시 소비자는 별도 미완료다. 공개 데모·인간 원형·본편 HOLD를 유지한다. |
