...
| **최근 완료** | **2026-06-19 UI 스킨 P1 2차** — StartMenu 난이도/런 테마 카드를 SVG 아이콘화, TutorialOverlay 중앙 아이콘을 Texture화, ScreenshotQA에 StartMenu/미니게임 본체 캡처 추가, 홀덤/경마 상단 조작 UI 이모지 축소 |
...
| **다음 작업** | **UI 스킨/미니게임 물체 에셋화 P1 계속** — StoryMode/정보 패널/세부 미니게임 버튼의 잔여 이모지 UI 정리 후, 룰렛 휠/볼·슬롯 심볼·경마 말/기수 스프라이트 확장 |
