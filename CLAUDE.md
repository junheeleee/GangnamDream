...
| **마지막 업데이트** | 2026-06-28 (Codex: Moral Surface Continuity Pass — 본편 배경·앰비언트·카테고리 틴트·선택지 구분선·정보 패널 탭·엔딩/데모 종료 보상색을 MORAL_TINT 무채색 언어에 맞춤. `audit.sh`, `english_hangul_audit.py`, `LocaleSurfaceCheck`, `ScreenshotQA --qa=moral`, `ScreenshotQA` full 통과.) |
