...
| 바로 다음 | M01~M06 첫 사람 판정에서 선택 전에 정확한 완료·놓침 효과를 보여 주는 스포일러 표면이 반려됐다. 행동·축·마감·한 번 미룸 가능 여부만 남기고 미래 문은 실제로 닥칠 때 드러나게 고친 뒤 다시 플레이한다. 사람 GO 전에는 기존 24주에 이관하지 않는다. |
...
| 마지막 갱신 | 2026-08-15 (Codex: M01~M06 선택 전 스포일러 표면 수정 중) |
