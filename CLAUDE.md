...
| 항목 | 내용 |
|---|---|
| **단계** | **미니게임 퀄리티 강화** — 카지노 게임 완성도 향상 (Week 2) |
| **최근 완료** | **강원랜드 바카라·블랙잭 구현 + 홀덤/경마 연출 강화 + 이미지 의미 매핑 2차** — 바카라 6덱 슈·카드순차공개·로드맵·커미션, 블랙잭 더블·스플릿·기본전략힌트, 홀덤 팟오즈/핸드히스토리/1-3팟레이즈 + POT/칩 버스트/페이즈 배너, 경마 트랙 전환·기수·속도선·실황 콜 (2026-06-15) |
| **다음 작업** | **투자 미니게임 개선** — ScalpingGame 차트 폴리시 + TradingFloor 시각화/손익 타격감 강화. 이후 경마·홀덤·바카라·블랙잭 실기 QA와 전용 SFX/스프라이트 고도화 |
| **마지막 업데이트** | 2026-06-15 (`origin/main` ebfa19e 병합 완료, Blackjack 타입 추론 컴파일 픽스, `./tools/audit.sh` ERROR 0 / WARNING 0 통과) |
