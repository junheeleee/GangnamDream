...
| 바로 다음 | 성향·관계·생활 칭호60을 포함해38,698(JA12,898·CN/TW각12,900)를 수용했다. 전체 수용 회귀 오류0·최종11검사 PASS·독립245/246 단위GO까지 닫았다. 최초 실패와 실제 검사 범위는 보존한다. 이전 exact41의 원격 CI 두 브랜치를 막은 검사 스크립트 지문 불일치2는 별도 좁은 수리로 진행한다. 남은31칭호와 실제 UI 소비자를 계속 다룬다. 후보별 CI·판정은 큐와 원장이 소유하며 공개GO1·인간OPEN45·본편HOLD는 유지한다. |
