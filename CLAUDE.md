...
| 바로 다음 | 공식 수용39,022(JA13,006·CN/TW각13,008)/b106/meta9다. 시스템 설정·저장18키의 세 언어54를 독립 언어검수·공식수용했다. CN/TW각13만 추가했고 JA 전체·기존28·공개공유15·old38,968 원형을 보존했다. 전체L1·고유12·단위판정은 exact 실행·독립보고가 소유한다. 실제 모달·렌더·원어민은 미관측이고 잔여 UI·실제 표시 소비자는 후속이다. 공개GO1·인간OPEN45·본편HOLD 유지. |
