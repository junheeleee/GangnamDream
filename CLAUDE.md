...
| **최근 완료** | **2026-07-11** — **Codex 첫눈 2종 + 민준 기후 P0 + StoryMode 명도/선택 도크 완료**: 다은/지연 겨울 초상, 편의점 외관/지연 세단 프리루드, 문단 1 CG를 배선하고 12월·시선·캔 2개·왼쪽 운전석을 계약화했다. 민준 장마·폭염·한파 초상과 한파 거리를 분리했다. Gray는 배경 구조가 읽히는 기록 톤, Black은 암전 대신 표면/주의 붕괴, White는 실제 색 회복으로 재조정했고 선택지는 대화창을 접는 하단 단일 도크를 쓴다. 활성 CG 28개/인물 계약 50개. |
...
| **마지막 업데이트** | 2026-07-11 (Codex: 첫눈 겨울 페어·민준 기후 초상·편의점/세단 구조·StoryMode 명도/선택 도크·won 표기) |
