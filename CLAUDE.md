...
| 최근 완료 | M34 여섯 terminal을 경찰 참고인 대기·용서 뒤 첫 대면·우대 배지·돌아온 입금·명단 밖 좌석·생활공간의 봉투라는 서로 다른 사건으로 다시 썼다. 여섯 장면은 각 1개의 진행 동작만 가지며, ORDER-107의 계약 보고체 20문장과 ORDER-106의 숫자 시각 도입 9개를 물성·사람 중심 산문으로 고쳤다. exact 16 roots L1/L2와 독립 P0/P1 0이며 M33/M39/M41/M42/M45/M46/M17/M19 정점은 선언 commit과 동일하다. |
| 바로 다음 | M49~M60의 투자/property·상철·다은·재혁·아버지 별세 기준 경로를 계약 원문 도착부터 마지막 서명 다음 주까지 실제 사건 20개로 먼저 완주한다. 기존 강한 M52/M54/M55/M57/M58/M60 원고는 보존하고, 새 reference 원고는 StoryLedger 이관 전 도달을 주장하지 않는다. |
...
| 그다음 | 사용자가 돌아오면 각 20단위 원고 표본과 M01~M06 체험판을 판정하고, 통과한 원고만 JA·zh-CN·zh-TW 번역 대상으로 잠근다. StoryLedger 이관은 원고와 분리하며 240주 감사는 RC에서만 실행한다. 순서는 [`CODEX_QUEUE.md`](docs/CODEX_QUEUE.md)가 소유한다. |
...
| 마지막 갱신 | 2026-08-18 (Codex: M34 여섯 사건·계약 보고체 20문장·시각 도입 9개 문학 보정 L1/L2 완료, 다음 M49~M60 원고) |
