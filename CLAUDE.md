...
| **다음 작업** | **인게임 에셋 QA** — Start/Splash/MainGame/Story CG/Holdem/RaceTrack 화면 크롭·톤 검수. UI 에셋(카드·칩·말 실루엣) 미니게임 연결. 미사용 PNG ~15개 정리. 빌드: `./tools/build.sh windows` |
| **마지막 업데이트** | 2026-06-09 (웹툰체 에셋 생성 → 인게임 QA 전환) |
