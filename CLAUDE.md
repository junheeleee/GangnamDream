...
| **마지막 업데이트** | 2026-06-20 (`audit.sh` ERROR 0/WARNING 0, ScreenshotQA 재캡처 OK: 룰렛 테이블/휠/숫자 매트, 홀덤 칩 위치, 경마 순위판 가림 해소, 슬롯머신 기기형 릴, 빅휠 분산 슬롯 외형 확인) |
