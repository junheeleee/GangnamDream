...
| 바로 다음 | 공식39,265(JA13,087·CN/TW13,089)/b111/meta9. 카드·생각정리18키/54를 독립 검수·정식 수용했다. 중국어36누락·JA5표현 수리, 첫L1 50/4는 별도266 오탐 수리와 함께 보존했다. 기존원장·선택 외 UI 보존과 최종 회귀를 마감한다. exact 단위판정은 큐가 소유한다. 실제화면·원어민 미관측, 공개GO1·인간OPEN45·본편HOLD 유지. |
