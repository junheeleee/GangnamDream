...
| **마지막 업데이트** | 2026-06-29 (Codex: Scalping Surface Pass — 스캘핑 미니게임 이모지 HUD/힌트/결과 표면 제거, 시작 후 설정 오버레이 잔존 버그 수정, 초반 캔들 폭/헤더 버튼 보정, 메인 종료 로그 톤 정리, `ScreenshotQA --qa=scalping-en` 추가.) |
