...
| 바로 다음 | 공식39,292(JA13,096·CN/TW13,098)/b112/meta9. 번역 지연 지적에 따라 기록 수리 뒤 중국어 UI 초안을 우선한다. 비보호 shipping 사건11,578은 세 언어 수용 완료. 잔여843은 참고741·보호 데모102로 활성 번역 공백이 아니다. UI 사전3015키 중 CN/TW각2446키가 없다(전체 UI 분모 아님). 상세는 번역 backlog, exact 판정은 큐가 소유한다. 초안9월23일은 연속 작업 전제의 추정이며 검수·출시 약속이 아니다. 공개GO1·인간OPEN45·본편HOLD 유지. |
