...
| 바로 다음 | Chapter 5 M49~M55의 인물·계약·선택 영수증을 연결한 뒤 M56~M60의 추적·접수·증언·거래·마지막 서명 actor를 잇는다. 장면 길이는 수치가 아니라 필요한 인과·감정 기능으로 정한다. |
...
| 마지막 갱신 | 2026-08-26 (Codex: 갤러리 최초 관람 무결성 완료) |
