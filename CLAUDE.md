...
| **마지막 업데이트** | 2026-06-22 (PC/Steam Deck 공통 Readability Pass 1: MainGame 전역 최소 폰트/버튼/포커스 기준 상향, 기본 모달 760x610 확대, 상단 HUD 1280x800 잘림 수정. ScreenshotQA 전체 2회 확인. 이전 외형 패스: 바카라/블랙잭 테이블 연출 강화, 다이사이 주사위 컵·콜 패널, 룰렛 매트/콜아웃, 슬롯 payout tray, 빅휠 상태 플레이트, 정선 카지노 허브 카드 스타일, 경마 결과 보드, 홀덤 쇼다운 판정 패널, 투자 MARKET BOARD.) |
