...
| **최근 완료** | **2026-06-17 후반24** — 자율 QA 심화: follow_up 전용 이벤트 hidden=true 3종 + BGM 엔딩 분류 수정 + 콜백 category 필드 119종 + 전수 감사 (98개 _seen플래그, 26개 엔딩, 11개 마일스톤, cast PID 등) 모두 이상 없음 |
