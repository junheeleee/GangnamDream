...
const TITLE_EN := {
	...
	"clean_run_title": {"name":"Clean Road to Gangnam", "cat":"Meta", "desc":"You began that life intending to leave gambling behind. It ended with at least 3 billion won in assets."},
	...
	"father_peace_title": {"name":"Last Spring", "cat":"Story", "desc":"Made peace with your father. The silence between you felt a little different."},
