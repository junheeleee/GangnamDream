...
The game does not yet provide four-season wardrobe coverage for every character. Runtime portrait selection is partly scene-specific and partly state-based. This document prevents partial coverage from being reported as complete.
...
|---|---|---|---|
| Kim Minjun general portrait | Job, housing/wealth, and emotion | Incomplete | Add summer/winter outdoor variants or keep weather events background-only; tired/happy overrides must not erase job/season without intent |
