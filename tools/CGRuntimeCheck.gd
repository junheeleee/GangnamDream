...
func _check_story_mode_cg() -> void:
	...
	await _check_story_event_cg("arc_season_sea_daeun_decision", "cg_romance_sea_daeun")
	await _check_story_event_cg("arc_season_sea_jiyeon_decision", "cg_romance_sea_jiyeon")
	await _check_story_event_cg("arc_season_fireworks_daeun_decision", "cg_romance_fireworks_daeun")
	await _check_story_event_cg("arc_season_fireworks_jiyeon_decision", "cg_romance_fireworks_jiyeon")
