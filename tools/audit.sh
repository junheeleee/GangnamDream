...
AUDIT_EXIT_FLAGS="
  CONTEXT_MANIFEST_EXIT QUEUE_CONSISTENCY_EXIT RELEASE_CONTENT_EXIT RELEASE_CONTENT_SELF_TEST_EXIT BUILD_IDENTITY_EXIT THIRD_PARTY_NOTICE_EXIT PY_EXIT OPPORTUNITY_MONEY_AUDIT_EXIT STORY_CONSISTENCY_EXIT STORY_MAP_EXIT YEAR5_REFERENCE_ROUTE_EXIT SPEECH_REGISTER_EXIT RANDOM_POOL_HYGIENE_EXIT SURFACE_EXIT
