...
def main() -> int:
    ...
    if not args.check:
        print("LAUNCH_AUDIO_GENERATOR_RETIRED use tools/build_sample_audio_assets.py")
        return 2
    result = audit_audio_sources()
    if result == 0:
        print("LAUNCH_AUDIO_GENERATOR_OK source=recordings_and_real_instrument_samples")
    return result
